  ...
  return (
    <div className="min-h-screen bg-[#070708] py-16 px-4">
      <div className="max-w-2xl mx-auto">
        <Link href="/dashboard" className="text-xs text-[#2563EB] hover:text-[#3B82F6] mb-8 inline-block">
          ← Back to Dashboard
        </Link>
        ...
        <div className="space-y-6 text-sm text-muted leading-relaxed">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs border-collapse">
                ...
                <tbody className="divide-y divide-white/5">
                  <tr>
                    <td className="py-2 pr-4 font-mono text-[#3B82F6]">sb-*-auth-token</td>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:privacy@shortstack.work" className="text-[#2563EB] hover:text-[#3B82F6]">
                privacy@shortstack.work
              </a>
              {" "}or visit our{" "}
              <Link href="/privacy" className="text-[#2563EB] hover:text-[#3B82F6]">
                Privacy Policy
              </Link>
              .
            </p>
