  ...
  return (
    <div className="min-h-screen bg-[#070708] py-16 px-4">
      <div className="max-w-2xl mx-auto">
        <Link href="/dashboard" className="text-xs text-[#2563EB] hover:text-[#3B82F6] mb-8 inline-block">Back to Dashboard</Link>
        ...
        <div className="space-y-6 text-sm text-muted leading-relaxed">
          <section>
            ...
            <p><strong className="text-foreground">Account Data:</strong> Name, email, password (encrypted), business information, and role.</p>
            <p className="mt-1"><strong className="text-foreground">Usage Data:</strong> Pages visited, features used, interactions with AI tools, and performance metrics.</p>
            <p className="mt-1"><strong className="text-foreground">Social Media Data:</strong> When you connect social accounts, we access account info, content, and analytics as authorized by you.</p>
            <p className="mt-1"><strong className="text-foreground">Lead Data:</strong> Business information scraped from public sources (Google Maps, public websites).</p>
          </section>
          ...
          <section>
            <h2 className="text-sm font-semibold text-foreground mb-2">3. Data Storage & Security</h2>
          ...
          <section>
            <h2 className="text-sm font-semibold text-foreground mb-2">4. AI Processing</h2>
          ...
          <section>
            <h2 className="text-sm font-semibold text-foreground mb-2">5. Social Media Permissions</h2>
          ...
          <section>
            <h2 className="text-sm font-semibold text-foreground mb-2">6. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-sm font-semibold text-foreground mb-2">9. Data Retention</h2>
