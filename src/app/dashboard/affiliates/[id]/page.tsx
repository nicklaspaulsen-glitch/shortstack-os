    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">AFFILIATE.NAME</p>
          <h1 className="text-2xl font-display font-bold text-text-primary">{affiliate.name}</h1>
        </div>
      ...
      <div className=" border border-border-subtle bg-card/40 p-5 space-y-3">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            onClick={copyRefLink}
            className="px-3 py-2 bg-brand-accent text-[#020711] rounded-full text-sm font-semibold flex items-center gap-2"
          >
            <Copy size={14} /> Copy
          </button>
        </div>
