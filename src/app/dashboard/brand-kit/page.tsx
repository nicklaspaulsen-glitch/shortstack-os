  ...
  return (
    <div className="fade-in p-6 max-w-7xl mx-auto space-y-6">
      ...
      {tab === "extract" && (
        ...
        >
          {/* URL Input */}
          <motion.div variants={tileVariants} className="rounded-xl p-8 text-center space-y-4" style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }}>
            ...
            <div className="max-w-lg mx-auto flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="rounded-lg w-full pl-9 py-2.5 text-sm bg-transparent focus:outline-none focus:ring-1 focus:ring-indigo-500/40 placeholder:text-muted" style={{ border: "1px solid rgba(255,255,255,0.1)" }}
                  disabled={loading}
                />
              </div>
              <motion.button
          ...
          <motion.div variants={containerVariants} className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <motion.div key={i} variants={tileVariants} whileHover={{ y: -2 }} className="rounded-xl p-4 text-center relative overflow-hidden" style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }}>
          ...
          {brand && (
            <motion.div variants={tileVariants} className="rounded-xl p-6 space-y-4" style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }}>
              ...
              <motion.div variants={containerVariants} className="grid grid-cols-4 gap-3">
                {[
                  ...
                  <motion.div
                    ...
                    whileHover={{ y: -2 }}
                    className="rounded-xl p-3 text-center relative overflow-hidden" style={{ background: "rgba(255,255,255,0.04)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.15)" }}
                  >
                    <div style={{ height: 3, background: RAINBOW }} className="absolute top-0 inset-x-0" />
      ...
      {tab === "colors" && brand && (
        ...
        >
          {/* Color palette */}
          <motion.div variants={tileVariants} className="rounded-xl p-6" style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }}>
                  ...
                  <motion.div variants={containerVariants} className="flex flex-wrap gap-2">
                    {brand.colors.slice(6).map((color) => (
                      <motion.button
                        ...
                        whileHover={{ x: 2 }}
                        onClick={() => copyColor(color)}
                        className="flex items-center gap-2 rounded-lg px-2.5 py-1.5 hover:border-indigo-500/30 transition-all text-xs" style={{ background: "rgba(255,255,255,0.035)", border: "1px solid rgba(255,255,255,0.1)" }}
                      >
          ...
          {brand.colors.length >= 2 && (
            <motion.div variants={tileVariants} className="rounded-xl p-6" style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }}>
              ...
              <motion.div variants={containerVariants} className="grid grid-cols-3 gap-3">
                {brand.colors.length >= 2 && (
                  <motion.div variants={tileVariants} className="rounded-lg p-3" style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }}>
              ...
              <motion.div variants={containerVariants} className="flex flex-wrap gap-2">
                {brand.socialLinks.map((s, i) => (
                  <motion.a
                    ...
                    className="flex items-center gap-2 rounded-lg px-3 py-2 hover:border-indigo-500/30 transition-all text-xs" style={{ background: "rgba(255,255,255,0.035)", border: "1px solid rgba(255,255,255,0.1)" }}
                  >
            ...
            {brand.fonts.length === 0 ? (
              ...
              <motion.div variants={containerVariants} className="space-y-4">
                {brand.fonts.map((font, i) => (
                  <motion.div key={i} variants={tileVariants} whileHover={{ y: -1 }} className="rounded-lg p-4" style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }}>
              ...
              <motion.div variants={containerVariants} className="space-y-2">
                {brand.headings.map((h, i) => (
                  <motion.div
                    ...
                    className="flex items-center justify-between rounded-lg px-3 py-2" style={{ background: "rgba(255,255,255,0.035)", border: "1px solid rgba(255,255,255,0.1)" }}
                  >
      ...
      {tab === "generate" && brand && (
        ...
        >
          ...
          <motion.div variants={tileVariants} className="rounded-xl p-4 flex items-center gap-4" style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }}>
            {brand.favicon && (
              // eslint-disable-next-line @next/next/no-img-element
