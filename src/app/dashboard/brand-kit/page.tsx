  ...
  return (
    <div className="fade-in p-6 max-w-7xl mx-auto space-y-6">
      ...
      {tab === "extract" && (
        ...
        >
          {/* URL Input */}
          <motion.div variants={tileVariants} className="rounded-xl p-8 text-center space-y-4" style={{ background: "#FFFFFF", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(0,0,0,0.10)" }}>
          ...
          <motion.div variants={containerVariants} className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <motion.div key={i} variants={tileVariants} whileHover={{ y: -2 }} className="rounded-xl p-4 text-center relative overflow-hidden" style={{ background: "#FFFFFF", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(0,0,0,0.10)" }}>
          ...
          {brand && (
            <motion.div variants={tileVariants} className="rounded-xl p-6 space-y-4" style={{ background: "#FFFFFF", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(0,0,0,0.10)" }}>
              ...
              <motion.div variants={containerVariants} className="grid grid-cols-4 gap-3">
                {[
                  ...
                  <motion.div
                    ...
                    whileHover={{ y: -2 }}
                    className="rounded-xl p-3 text-center relative overflow-hidden" style={{ background: "rgba(0,0,0,0.03)", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(0,0,0,0.16)" }}
                  >
                    <div style={{ height: 3, background: RAINBOW }} className="absolute top-0 inset-x-0" />
      ...
      {tab === "colors" && brand && (
        ...
        >
          {/* Color palette */}
          <motion.div variants={tileVariants} className="rounded-xl p-6" style={{ background: "#FFFFFF", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(0,0,0,0.10)" }}>
                  ...
                  <motion.div variants={containerVariants} className="flex flex-wrap gap-2">
                    {brand.colors.slice(6).map((color) => (
                      <motion.button
                        ...
                        whileHover={{ x: 2 }}
                        onClick={() => copyColor(color)}
                        className="flex items-center gap-2 rounded-lg px-2.5 py-1.5 hover:border-indigo-500/30 transition-all text-xs" style={{ background: "#FFFFFF", border: "1px solid rgba(0,0,0,0.10)" }}
                      >
          ...
          {brand.colors.length >= 2 && (
            <motion.div variants={tileVariants} className="rounded-xl p-6" style={{ background: "#FFFFFF", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(0,0,0,0.10)" }}>
              ...
              <motion.div variants={containerVariants} className="grid grid-cols-3 gap-3">
                {brand.colors.length >= 2 && (
                  <motion.div variants={tileVariants} className="rounded-lg p-3" style={{ background: "#FFFFFF", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(0,0,0,0.10)" }}>
              ...
              <motion.div variants={containerVariants} className="flex flex-wrap gap-2">
                {brand.socialLinks.map((s, i) => (
                  <motion.a
                    ...
                    className="flex items-center gap-2 rounded-lg px-3 py-2 hover:border-indigo-500/30 transition-all text-xs" style={{ background: "#FFFFFF", border: "1px solid rgba(0,0,0,0.10)" }}
                  >
            ...
            {brand.fonts.length === 0 ? (
              ...
              <motion.div variants={containerVariants} className="space-y-4">
                {brand.fonts.map((font, i) => (
                  <motion.div key={i} variants={tileVariants} whileHover={{ y: -1 }} className="rounded-lg p-4" style={{ background: "#FFFFFF", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(0,0,0,0.10)" }}>
              ...
              <motion.div variants={containerVariants} className="space-y-2">
                {brand.headings.map((h, i) => (
                  <motion.div
                    ...
                    className="flex items-center justify-between rounded-lg px-3 py-2" style={{ background: "#FFFFFF", border: "1px solid rgba(0,0,0,0.10)" }}
                  >
      ...
      {tab === "generate" && brand && (
        ...
        >
          ...
          <motion.div variants={tileVariants} className="rounded-xl p-4 flex items-center gap-4" style={{ background: "#FFFFFF", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(0,0,0,0.10)" }}>
            {brand.favicon && (
              // eslint-disable-next-line @next/next/no-img-element
            ...
            <motion.div variants={containerVariants} className="grid grid-cols-2 gap-3">
              {GENERATE_PRESETS.map((preset) => (
                <motion.button
                  ...
                  disabled={generating}
                  style={{ background: "#FFFFFF", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(0,0,0,0.10)" }}
