...
const MOCK_CONVERSATIONS: Conversation[] = [
  {
    id: "c1", clientName: "Meridian Health", clientAvatar: "MH",
    email: "dr.patel@meridianhealth.com", phone: "+1 (555) 234-5678",
    lastMessage: "The new social media calendar looks amazing! Can we add more video content for next month?",
    lastTimestamp: "2026-04-15T09:15:00", unread: 2,
    messages: [
      { id: "m1", direction: "inbound", channel: "email", text: "Hi team, just reviewed the Q2 content plan. Really impressed with the direction!", status: "read", timestamp: "2026-04-15T08:30:00", sender: "Dr. Patel" },
      { id: "m2", direction: "outbound", channel: "email", text: "Thank you Dr. Patel! We put extra focus on patient education content based on your feedback. The infographics are being designed now.", status: "delivered", timestamp: "2026-04-15T08:45:00", sender: "Sarah K." },
      { id: "m3", direction: "inbound", channel: "email", text: "The new social media calendar looks amazing! Can we add more video content for next month?", status: "read", timestamp: "2026-04-15T09:15:00", sender: "Dr. Patel" },
      { id: "m4", direction: "inbound", channel: "portal", text: "Also uploaded our new staff photos to the brand kit", status: "read", timestamp: "2026-04-15T09:20:00", sender: "Dr. Patel" },
    ],
    status: "open", priority: "medium", assignee: "Sarah K.", tags: ["content", "video"], sentiment: "positive", channel: "email",
  },
  {
    id: "c2", clientName: "Peak Performance Gym", clientAvatar: "PP",
    email: "mike@peakperformance.fit", phone: "+1 (555) 345-6789",
    lastMessage: "Ad spend is way higher than discussed. Need to talk ASAP.",
    lastTimestamp: "2026-04-15T08:02:00", unread: 1,
    messages: [
      { id: "m5", direction: "outbound", channel: "whatsapp", text: "Hi Mike! Your April ad campaign is live. Here's the initial performance dashboard link.", status: "delivered", timestamp: "2026-04-14T14:00:00", sender: "Alex M." },
      { id: "m6", direction: "inbound", channel: "whatsapp", text: "Thanks. Why does the dashboard show $800 spend already? Budget was $500 for the week.", status: "read", timestamp: "2026-04-14T16:30:00", sender: "Mike" },
      { id: "m7", direction: "outbound", channel: "whatsapp", text: "Good catch - let me look into this right away. Could be the weekend campaign overlap.", status: "delivered", timestamp: "2026-04-14T16:45:00", sender: "Alex M." },
      { id: "m8", direction: "inbound", channel: "whatsapp", text: "Ad spend is way higher than discussed. Need to talk ASAP.", status: "read", timestamp: "2026-04-15T08:02:00", sender: "Mike" },
    ],
    status: "open", priority: "high", assignee: "Alex M.", tags: ["ads", "urgent", "budget"], sentiment: "negative", channel: "whatsapp",
  },
  {
    id: "c3", clientName: "Bloom Dental", clientAvatar: "BD",
    email: "office@bloomdental.com", phone: "+1 (555) 456-7890",
    lastMessage: "Perfect, the landing page copy is approved. Go ahead and publish!",
    lastTimestamp: "2026-04-14T17:30:00", unread: 0,
    messages: [
      { id: "m9", direction: "outbound", channel: "email", text: "Hi there! Here's the revised landing page copy for the teeth whitening campaign. Changes highlighted in yellow.", status: "delivered", timestamp: "2026-04-14T10:00:00", sender: "Sarah K." },
      { id: "m10", direction: "inbound", channel: "email", text: "This looks great! One small tweak - can we change 'affordable' to 'accessible'? Sounds more professional.", status: "read", timestamp: "2026-04-14T14:20:00", sender: "Dr. Chen" },
      { id: "m11", direction: "outbound", channel: "email", text: "Done! Updated copy attached. Great call on the wording change.", status: "delivered", timestamp: "2026-04-14T15:00:00", sender: "Sarah K." },
      { id: "m12", direction: "inbound", channel: "email", text: "Perfect, the landing page copy is approved. Go ahead and publish!", status: "read", timestamp: "2026-04-14T17:30:00", sender: "Dr. Chen" },
    ],
    status: "resolved", priority: "low", assignee: "Sarah K.", tags: ["content", "approved"], sentiment: "positive", channel: "email",
  },
  {
    id: "c4", clientName: "Urban Eats Kitchen", clientAvatar: "UE",
    email: "chef@urbaneats.com", phone: "+1 (555) 567-8901",
    lastMessage: "Can you schedule the Mother's Day promo posts? Menu attached.",
    lastTimestamp: "2026-04-14T11:00:00", unread: 1,
    messages: [
      { id: "m13", direction: "inbound", channel: "sms", text: "Hey! We have a special Mother's Day brunch menu launching next week", status: "read", timestamp: "2026-04-14T10:00:00", sender: "Chef Marco" },
      { id: "m14", direction: "outbound", channel: "sms", text: "Awesome! Send over the menu details and any photos. We'll create posts + stories for all platforms.", status: "delivered", timestamp: "2026-04-14T10:15:00", sender: "Mike T." },
      { id: "m15", direction: "inbound", channel: "portal", text: "Can you schedule the Mother's Day promo posts? Menu attached.", status: "read", timestamp: "2026-04-14T11:00:00", sender: "Chef Marco", attachments: ["mothers-day-menu.pdf"] },
    ],
    status: "open", priority: "medium", assignee: "Mike T.", tags: ["content", "promo", "scheduling"], sentiment: "neutral", channel: "sms",
  },
  {
    id: "c5", clientName: "TechFlow SaaS", clientAvatar: "TF",
    email: "marketing@techflow.io", phone: null,
    lastMessage: "The SEO report shows a 32% increase in organic traffic. Incredible work!",
    lastTimestamp: "2026-04-13T16:00:00", unread: 0,
    messages: [
      { id: "m16", direction: "outbound", channel: "email", text: "Hi team! Attached is the March SEO performance report. Key highlights: 32% traffic increase, 15 new ranking keywords.", status: "delivered", timestamp: "2026-04-13T14:00:00", sender: "Sarah K." },
      { id: "m17", direction: "inbound", channel: "email", text: "The SEO report shows a 32% increase in organic traffic. Incredible work!", status: "read", timestamp: "2026-04-13T16:00:00", sender: "Lisa" },
    ],
    status: "resolved", priority: "low", assignee: "Sarah K.", tags: ["seo", "reporting"], sentiment: "positive", channel: "email",
  },
  {
    id: "c6", clientName: "Swift Auto Repair", clientAvatar: "SA",
    email: "tom@swiftauto.com", phone: "+1 (555) 678-9012",
    lastMessage: "Still waiting on the Google Ads setup. It's been 2 weeks now.",
    lastTimestamp: "2026-04-15T07:45:00", unread: 3,
    messages: [
      { id: "m18", direction: "inbound", channel: "whatsapp", text: "When will the Google Ads be live? You said by end of last week.", status: "read", timestamp: "2026-04-12T09:00:00", sender: "Tom" },
      { id: "m19", direction: "outbound", channel: "whatsapp", text: "Apologies for the delay, Tom. We ran into some issues with the conversion tracking setup. Should be resolved by Wednesday.", status: "delivered", timestamp: "2026-04-12T11:00:00", sender: "Alex M." },
      { id: "m20", direction: "inbound", channel: "whatsapp", text: "It's Friday and still nothing. This is really frustrating.", status: "read", timestamp: "2026-04-14T15:00:00", sender: "Tom" },
      { id: "m21", direction: "inbound", channel: "whatsapp", text: "Still waiting on the Google Ads setup. It's been 2 weeks now.", status: "read", timestamp: "2026-04-15T07:45:00", sender: "Tom" },
    ],
    status: "open", priority: "high", assignee: "Alex M.", tags: ["ads", "urgent", "delayed"], sentiment: "negative", channel: "whatsapp",
  },
  {
    id: "c7", clientName: "Luxe Salon & Spa", clientAvatar: "LS",
    email: "hello@luxesalon.com", phone: "+1 (555) 789-0123",
    lastMessage: "Love the new Instagram Reels! Our followers are going crazy",
    lastTimestamp: "2026-04-13T12:00:00", unread: 0,
    messages: [
      { id: "m22", direction: "outbound", channel: "portal", text: "Your April content batch is ready for review in the portal! 12 posts including 4 Reels.", status: "delivered", timestamp: "2026-04-12T09:00:00", sender: "Mike T." },
      { id: "m23", direction: "inbound", channel: "portal", text: "Love the new Instagram Reels! Our followers are going crazy", status: "read", timestamp: "2026-04-13T12:00:00", sender: "Jessica" },
    ],
    status: "resolved", priority: "low", assignee: "Mike T.", tags: ["content", "social", "reels"], sentiment: "positive", channel: "portal",
  },
];

const AI_SUGGESTIONS: Record<string, string[]> = {
  c1: [
    "Absolutely! We can increase video content to 8 pieces next month. I'll draft an updated calendar for your review.",
    "Great idea! Video has been performing 3x better for your audience. Let me propose a video-first content strategy.",
  ],
  c2: [
    "I understand your concern, Mike. I've paused the campaign and will have a full spend breakdown ready within the hour.",
    "You're right to flag this. I've investigated and found the weekend overlap issue. Sending you an adjusted budget plan now.",
  ],
  c4: [
    "Got the menu! I'll have all Mother's Day promo content scheduled by end of day tomorrow across Instagram, Facebook, and TikTok.",
    "Perfect timing! I'll create a full campaign including posts, stories, and a special email blast. Preview coming Thursday.",
  ],
  c6: [
    "Tom, I sincerely apologize for the continued delay. The ads are going live today - I'll send you the live dashboard link by 3 PM.",
    "I completely understand your frustration. As a goodwill gesture, we're adding an extra week of free ad management. Campaign goes live within 2 hours.",
  ],
};
