export default function DashboardLoading() {
  return (
    <div className="space-y-5 p-1">
      ...
      <div className="relative overflow-hidden  border border-border-subtle bg-gradient-to-br from-[rgba(59,130,246,0.08)] via-[rgba(59,130,246,0.03)] to-transparent p-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-xl border border-border-subtle bg-surface p-4 space-y-3 animate-pulse" style={{ animationDelay: `${i * 60}ms` }}>
      ...
      <div className="space-y-2">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="rounded-xl border border-border-subtle bg-surface p-3 flex items-center gap-3 animate-pulse" style={{ animationDelay: `${80 + i * 40}ms` }}>
