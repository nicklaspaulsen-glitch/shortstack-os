  ...
  return (
    ...
    <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
      <div className="min-w-0">
        <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">Trigger &amp; Orchestrate</p>
        <h1 className="text-2xl font-display font-bold text-text-primary">Automations</h1>
      </div>
      <div className="flex items-center gap-2 shrink-0">
        <div className="flex items-center gap-2">
                  <Link
                    href="/dashboard/automations/library"
                    className="btn-pill-ghost text-sm flex items-center gap-2"
                  >
                  ...
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Link
                      ...
                      className="btn-pill text-sm flex items-center gap-2"
                    >
