  ...
  return (
    ...
    <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
      <div className="min-w-0">
        <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">Alerts &amp; Updates</p>
                ...
                {TABS.map((tab) => (
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[11px] font-medium whitespace-nowrap transition-all ${
                      activeTab === tab.key
                        ? "text-brand-accent bg-[rgba(212,255,0,0.08)] border border-[rgba(212,255,0,0.2)]"
                  ...
                  >
                    ...
                    {tabCounts[tab.key] > 0 && (
                      <span className={`text-[9px] px-1.5 py-0.5 rounded-full ${
                        activeTab === tab.key ? "bg-[rgba(212,255,0,0.12)] text-brand-accent" : "bg-surface-light text-text-muted"
                      }`}>
                        {tabCounts[tab.key]}
                      </span>
                    )}
                ...
                {TABS.filter((t) => t.key !== "all").map((tab, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {unread > 0 && (
                        <span className="text-[8px] text-brand-accent bg-[rgba(212,255,0,0.08)] px-1.5 py-0.5 rounded-full mt-1 inline-block">
                          {unread} new
                        </span>
                      )}
                    </motion.button>
