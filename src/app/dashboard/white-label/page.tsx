    ...
    <div className="flex flex-col gap-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">Agency Branding</p>
          <h1 className="text-2xl font-display font-bold text-text-primary">White Label</h1>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <p className="text-xs font-semibold uppercase tracking-widest text-text-muted">Branding</p>
          ...
          <Field label="Logo URL" hint="Direct link to your logo image (PNG/SVG recommended)">
            <div className="flex gap-2">
              ...
              <Image className="w-5 h-5 text-text-muted shrink-0 self-center" />
            </div>
          </Field>
            ...
            <>
              ...
              {!config.custom_domain_verified && (
                <div className="rounded-lg bg-white/5 border border-border-subtle p-3 flex flex-col gap-2 text-xs">
                  ...
                  <p className="text-text-muted">DNS propagation takes 5-30 minutes. SSL is provisioned automatically once verified.</p>
                </div>
              )}
        ...
        >
          ...
          <div className="p-5 flex flex-col gap-4">
          <p className="text-xs font-semibold uppercase tracking-widest text-text-muted">Email and Portal Copy</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
