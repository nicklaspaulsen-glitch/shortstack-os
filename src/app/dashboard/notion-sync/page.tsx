    ...
    <div className="flex flex-col gap-6 max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">Knowledge Sync</p>
          <h1 className="text-2xl font-display font-bold text-text-primary">Notion Sync</h1>
        </div>
      </div>
