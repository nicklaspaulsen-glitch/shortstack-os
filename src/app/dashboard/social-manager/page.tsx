...
export default function SocialManagerPage() {
  ...
  return (
    <div className="fade-in space-y-5">
            ...
            <PrismPanel padding="p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {suggestions.slice(0, 6).map((s, idx) => {
                  ...
                  return (
                    <motion.div key={s.id} initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: idx * 0.04 }} whileHover={{ y: -4, scale: 1.01 }} style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }} className="rounded-xl p-2.5 hover:border-gold/10 transition-all">
      ...
      {tab === "hashtags" && (
        <div className="space-y-4">
          <div style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }} className="rounded-xl relative overflow-hidden">
            <div className="absolute inset-0 bg-mesh opacity-30" />
            <div className="relative">
      ...
      {tab === "scheduled" && (
        <div className="space-y-2">
          {scheduledPosts.length === 0 ? (
            <div style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }} className="rounded-xl text-center py-8">
            ...
            scheduledPosts.map((post, idx) => {
              const meta = (post.metadata as Record<string, unknown>) || {};
              return (
                <motion.div key={post.id} initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: idx * 0.04 }} style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }} className="rounded-xl p-3">
        ...
        <div className="space-y-2">
          {recentPosts.length === 0 ? (
            ...
            recentPosts.map((post, idx) => (
              <motion.div key={post.id} initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: idx * 0.04 }} style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }} className="rounded-xl p-3 flex items-center gap-3">
      ...
      {tab === "config" && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="rounded-xl p-5 space-y-4" style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }}>
          ...
          {/* Autopilot Controls */}
          <div className="space-y-4">
            <div style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }} className="rounded-xl p-5">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
      ...
      {tab === "tools" && (
        <div className="space-y-4">
          ...
          {/* 18. Post Preview */}
          {toolsSubTab === "preview" && (
            <div className="rounded-xl p-4 space-y-3" style={{ background: "rgba(255,255,255,0.035)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.1)" }}>
              <div className="flex items-center gap-2">
