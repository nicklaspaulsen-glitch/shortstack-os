    ...
    <div className="space-y-6 max-w-[1200px] mx-auto">
      ...
      <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">DISCORD</p>
          <h1 className="text-2xl font-display font-bold text-text-primary">Discord</h1>
        </div>
      ...
      {activeTab === "Commands" && (
        <div className="space-y-4">
            ...
            <div className="flex gap-1">
              {["All", "Info", "Reports", "Tools"].map(f => (
                <button key={f} onClick={() => setCommandFilter(f)}
                  className={`text-[10px] px-2.5 py-1 rounded-full border ${commandFilter === f ? "border-brand-accent text-brand-accent bg-[rgba(212,255,0,0.05)]" : "border-border-subtle text-text-muted"}`}>{f}</button>
              ))}
            </div>
          </div>
              ...
              <div key={cmd.name} className="glass rounded-xl p-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div onClick={() => toggleCommand(cmd.name)}
                    className={`w-9 h-5 rounded-full cursor-pointer transition-all flex items-center ${cmd.enabled ? "bg-brand-accent" : "bg-white/20"}`}>
          ...
          <div className="glass rounded-xl p-4">
            ...
            <button className="mt-3 text-xs bg-[rgba(212,255,0,0.08)] text-brand-accent px-4 py-2 rounded-lg font-medium hover:bg-[rgba(212,255,0,0.12)]">Register Command</button>
          </div>
        </div>
      )}
      ...
      {activeTab === "Auto-Roles" && (
        <div className="space-y-4">
            ...
            {autoRoles.map(role => (
              <div key={role.id} className="glass rounded-xl p-3 flex items-center justify-between">
                ...
                <div onClick={() => toggleAutoRole(role.id)}
                  className={`w-9 h-5 rounded-full cursor-pointer transition-all flex items-center ${role.enabled ? "bg-brand-accent" : "bg-white/20"}`}>
          ...
          <div className="glass rounded-xl p-4">
            ...
            <button className="mt-3 text-xs bg-[rgba(212,255,0,0.08)] text-brand-accent px-4 py-2 rounded-lg font-medium hover:bg-[rgba(212,255,0,0.12)]">Add Rule</button>
          </div>
        </div>
      )}
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              ...
              <div className="flex items-center justify-between p-2.5 rounded-lg bg-surface-light border border-border-subtle">
                ...
                <div onClick={() => setWelcomeChannel(!welcomeChannel)}
                  className={`w-9 h-5 rounded-full cursor-pointer transition-all flex items-center ${welcomeChannel ? "bg-brand-accent" : "bg-white/20"}`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div onClick={() => toggleModRule(rule.id)}
                      className={`w-9 h-5 rounded-full cursor-pointer transition-all flex items-center ${rule.enabled ? "bg-brand-accent" : "bg-white/20"}`}>
      ...
      {activeTab === "Events" && (
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => setShowNewEvent(!showNewEvent)} className="text-xs bg-[rgba(212,255,0,0.08)] text-brand-accent px-3 py-1.5 rounded-lg font-medium flex items-center gap-1.5">
          ...
          {showNewEvent && (
            <div className="glass rounded-xl p-4">
              ...
              <button className="mt-3 text-xs bg-[rgba(212,255,0,0.08)] text-brand-accent px-4 py-2 rounded-lg font-medium">Create Event</button>
            </div>
          )}
      ...
      {activeTab === "Webhooks" && (
        <div className="space-y-4">
          ...
          <div className="glass rounded-xl p-4">
            ...
            <button className="mt-3 text-xs bg-[rgba(212,255,0,0.08)] text-brand-accent px-4 py-2 rounded-lg font-medium hover:bg-[rgba(212,255,0,0.12)]">Create Webhook</button>
          </div>
        </div>
      )}
        ...
        <div className="space-y-4">
          ...
          <div className="glass rounded-xl p-4">
            ...
            <div className="space-y-3">
              ...
              <button className="text-xs bg-[rgba(212,255,0,0.08)] text-brand-accent px-4 py-2 rounded-lg font-medium hover:bg-[rgba(212,255,0,0.12)]">Schedule</button>
            </div>
          </div>
          <div className="flex flex-col items-center justify-center py-8 text-center">
