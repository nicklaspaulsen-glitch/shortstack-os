        ...
        <h1 className="font-display text-xl sm:text-2xl font-bold tracking-tight text-text-primary leading-none">Triggers</h1>
              ...
              >
                ...
                <ul className="ml-4 list-disc space-y-1">
                  ...
                  <li>
                    Build the workflow first in <Link href="/dashboard/workflow-builder" className="text-brand-accent underline">Workflow Builder</Link>,
    ...
    <div className="glass-md rounded-xl border border-[rgba(59,130,246,0.25)] p-5">
          ...
          {TRIGGER_CATALOG.map((t) => {
            ...
            return (
              ...
              >
                ...
                {active && <Check size={12} className="shrink-0 text-brand-accent" />}
              </button>
            );
          })}
        </div>
      ...
      <div className="mb-5">
        ...
        {workflows.length === 0 ? (
          <div className="rounded-lg border border-dashed border-border/50 p-4 text-center text-sm">
            <AlertCircle size={16} className="mx-auto mb-1 text-brand-accent" />
            <p className="mb-2 text-muted">You have no workflows yet.</p>
            <Link
              href="/dashboard/workflow-builder"
              className="inline-flex items-center gap-1 rounded-lg bg-brand-accent px-3 py-1.5 text-xs font-semibold text-white"
            >
      ...
      <div className="flex items-center justify-end gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg bg-brand-accent px-5 py-2 text-sm font-semibold text-white transition hover:bg-brand-accent/80 disabled:opacity-40"
        >
          {submitting ? (
            <>
