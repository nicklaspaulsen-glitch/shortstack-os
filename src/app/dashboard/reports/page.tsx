...
export default function ReportsPage() {
  ...
  function buildReportMarkdown(report: GeneratedReport): string {
    ...
    lines.push("");
    lines.push(`---`);
    lines.push(`Generated by ShortStack OS on ${new Date().toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}`);
    return lines.join("\n");
  }
...
<body>
  ...
  <div class="container">
    ...
    <div class="footer">
      <p class="footer-text">Generated by ShortStack OS &bull; ${new Date().toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}</p>
    </div>
  </div>
</body>
</html>`;
