...
const STATUS_COLORS: Record<string, string> = {
  ...
  converted: "bg-[rgba(37,99,235,0.08)] text-brand-accent border-[rgba(37,99,235,0.2)]",
  ...
  return (
    <MotionPage className="fade-in space-y-3"><ErrorBoundary section="CRM">
            ...
            <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
              ...
              {stats.total> 0 && (
                <span className="shrink-0 flex items-center gap-1 px-2.5 py-1 rounded-full bg-[rgba(37,99,235,0.08)] border border-[rgba(37,99,235,0.15)] text-[10px] font-medium text-brand-accent">
            ...
            <div className="sticky top-0 z-10 bg-background/95 backdrop-blur flex items-center justify-between flex-wrap gap-2 py-2 -mx-1 px-1">
              <div className="flex items-center gap-2 flex-wrap">
                {hasActiveFilters && (
                  <span className="text-[8px] px-2 py-0.5 rounded-full bg-[rgba(37,99,235,0.08)] text-brand-accent border border-[rgba(37,99,235,0.2)] flex items-center gap-1">
              ...
              <div className="flex items-center gap-1.5 overflow-x-auto">
                ...
                {savedSegments.map(seg => (
                  <button key={seg.id} onClick={() => loadSegment(seg)}
                    className="text-[8px] px-2 py-1 rounded-full border border-border bg-surface-light hover:border-[rgba(37,99,235,0.2)] hover:text-brand-accent transition-all whitespace-nowrap flex items-center gap-1">
                    {seg.name}
                ...
                <button onClick={() => setShowSegmentSave(true)} className="text-[8px] px-2 py-1 rounded-full border border-dashed border-border text-muted hover:text-brand-accent hover:border-[rgba(37,99,235,0.2)] transition-all flex items-center gap-1">
              ...
              <div className="card p-3 flex flex-wrap gap-2">
                ...
                {columns.filter(c => c.key !== "select" && c.key !== "expand").map(col => (
                  <button key={col.key} onClick={() => setColumns(prev => prev.map(c => c.key === col.key ? { ...c, visible: !c.visible } : c))}
                    className={`text-[9px] px-2 py-1 rounded-lg border transition-all flex items-center gap-1 ${col.visible ? "border-[rgba(37,99,235,0.2)] bg-[rgba(37,99,235,0.08)] text-brand-accent" : "border-border text-muted"}`}>
                        ...
                        <div className="flex rounded-lg overflow-hidden border border-border text-[8px]">
                          {[
                            ...
                            <button key={String(o.val)} onClick={() => setFilters(prev => ({ ...prev, [f.key]: o.val }))}
                              className={`px-1.5 py-0.5 ${filters[f.key] === o.val ? "bg-[rgba(37,99,235,0.08)] text-brand-accent" : "text-muted"}`}>
                              {o.label}
                            </button>
                          ))}
                        </div>
                      ...
                      <div className="flex rounded-lg overflow-hidden border border-border text-[8px]">
                        {[
                          ...
                          <button key={String(o.val)} onClick={() => setFilters(prev => ({ ...prev, isStale: o.val }))}
                            className={`px-2 py-1 ${filters.isStale === o.val ? "bg-[rgba(37,99,235,0.08)] text-brand-accent" : "text-muted"}`}>
                            {o.label}
                          </button>
                        ))}
                      </div>
            ...
            <div className="tab-group w-fit">
              {STATUS_TABS.map(t => (
                <button key={t.key} onClick={() => setActiveTab(t.key)}
                  ...
                  {t.label}
                  <span className={`text-[8px] px-1.5 py-0.5 rounded-full ${activeTab === t.key ? "bg-[rgba(37,99,235,0.12)] text-brand-accent" : "bg-surface-light text-muted"}`}>
              ...
              {selectedIds.size> 0 ? (
                <>
                  ...
                  <div className="flex items-center gap-1 flex-wrap">
                    <button onClick={() => bulkAction("email")} className="text-[8px] px-2 py-1 rounded-lg bg-[rgba(37,99,235,0.08)] text-brand-accent hover:bg-[rgba(37,99,235,0.12)] transition-all flex items-center gap-1"><Mail size={9} /> Email All</button>
                                      ...
                                      <td key={col.key} className={`px-2 ${dPy}`} onClick={e => e.stopPropagation()}>
                                        <div className="flex items-center gap-0.5">
                                          <button onClick={() => sendAction(lead, "email")} disabled={!lead.email || actionLoading === `${lead.id}-email`}
                                            className="text-[8px] p-1 rounded-lg bg-[rgba(37,99,235,0.08)] text-brand-accent hover:bg-[rgba(37,99,235,0.12)] disabled:opacity-30 transition-all" title="Email">
                                            <Mail size={10} />
                                          </button>
                        ...
                        <motion.div
                          ...
                          <div className="flex items-center justify-between pt-1 border-t border-border/50">
                            ...
                            <div className="flex items-center gap-0.5" onClick={e => e.stopPropagation()}>
                              <button onClick={() => sendAction(lead, "email")} disabled={!lead.email} className="p-1 rounded bg-[rgba(37,99,235,0.08)] text-brand-accent hover:bg-[rgba(37,99,235,0.12)] disabled:opacity-30" aria-label="Send email"><Mail size={9} /></button>
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="flex items-center gap-1">
                      <button onClick={() => sendAction(detailLead, "email")} disabled={!detailLead.email}
                        className="flex-1 text-[9px] py-1.5 rounded-lg bg-[rgba(37,99,235,0.08)] text-brand-accent hover:bg-[rgba(37,99,235,0.12)] disabled:opacity-30 flex items-center justify-center gap-1"><Mail size={10} /> Email</button>
                      ...
                      <div className="flex flex-wrap gap-1">
                        ...
                        {AVAILABLE_TAGS.filter(t => !(leadTags[detailLead.id] || []).includes(t.id)).slice(0, 4).map(tag => (
                          <button key={tag.id} onClick={() => addTag(detailLead.id, tag.id)}
                            className="text-[8px] px-1.5 py-0.5 rounded-full border border-dashed border-border text-muted hover:text-brand-accent hover:border-[rgba(37,99,235,0.2)] transition-all">
                            + {tag.label}
                          </button>
                        ))}
                      </div>
                    ...
                    <div>
                      ...
                      <div className="flex gap-1 mb-2">
                        ...
                        <button onClick={() => addNote(detailLead.id)} className="text-[9px] px-2 py-1 rounded-lg bg-[rgba(37,99,235,0.08)] text-brand-accent hover:bg-[rgba(37,99,235,0.12)]"><Plus size={10} /></button>
                      </div>
                ...
                <div className="bg-surface border border-border shadow-2xl max-w-2xl w-full mx-4 max-h-[80vh] overflow-hidden" onClick={e => e.stopPropagation()}>
                  ...
                  <div className="p-5 overflow-y-auto max-h-[60vh] space-y-3">
                    ...
                    <button onClick={addAutomation}
                      className="w-full text-[10px] py-2 rounded-xl border border-dashed border-border text-muted hover:text-brand-accent hover:border-[rgba(37,99,235,0.2)] transition-all flex items-center justify-center gap-1">
