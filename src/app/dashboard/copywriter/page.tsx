...
export default function CopywriterPage() {
  ...
  return (
    <MotionPage className="max-w-7xl mx-auto space-y-6">{/* -- AI Copywriter command strip -- */}
            <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4 mb-6">
              <div className="min-w-0">
                <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">Copy Engine</p>
                <h1 className="text-2xl font-display font-bold text-text-primary">AI Copywriter</h1>
              </div>
                    ...
                    {history.map((item, i) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className="w-full text-left p-3 border-b border-white/10 last:border-0 transition-all group flex items-start gap-3"
                        >
                          <div
