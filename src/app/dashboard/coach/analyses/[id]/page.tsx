      ...
      <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-md border border-border-subtle bg-black/5 px-3 py-1.5 text-xs font-medium text-text-primary hover:bg-black/5"
          >
