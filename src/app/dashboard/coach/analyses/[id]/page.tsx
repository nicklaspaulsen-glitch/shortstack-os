    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">AI Sales Coach</p>
          <h1 className="text-2xl font-display font-bold text-text-primary">{`Score ${analysis.overall_score ?? "—"}`}</h1>
        </div>
