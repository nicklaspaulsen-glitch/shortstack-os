    ...
    <MotionPage className="space-y-4"><ErrorBoundary section="Lead Finder">
            ...
            <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
              <div className="min-w-0">
                <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">Prospecting Engine</p>
                <h1 className="text-2xl font-display font-bold text-text-primary">Lead Finder</h1>
              </div>
            </div>
                      ...
                      <div className="space-y-3">
                              ...
                              <button
                                ...
                                className={`w-8 h-8 rounded-lg text-[10px] font-bold transition-all ${
                                  autoRunDays.includes(day.id)
                                    ...
                                    : "bg-surface-light text-text-muted border border-border-subtle hover:border-[rgba(212,255,0,0.25)]"
                                }`}
                              >
                                {day.label}
                              </button>
                        ...
                        <div className="p-2.5 bg-surface-light rounded-lg border border-border-subtle">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {selectedPlatforms.map(p => <span key={p} className="text-[8px] bg-[rgba(212,255,0,0.08)] text-brand-accent px-1.5 py-0.5 rounded">{p.replace("_", " ")}</span>)}
                            {niches.slice(0, 3).map(n => <span key={n} className="text-[8px] bg-[rgba(212,255,0,0.08)] text-brand-accent px-1.5 py-0.5 rounded">{n}</span>)}
                      ...
                      <button
                        ...
                        className={`px-3 py-1 rounded-lg text-xs font-medium border transition-all ${
                          targetMode === mode.id
                            ...
                            : "border-border-subtle text-text-muted hover:text-text-primary hover:border-[rgba(212,255,0,0.25)]"
                        }`}
                      >
                        {mode.label}
                      </button>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {REVENUE_RANGES.map(r => (
                              <button key={r} onClick={() => setFilters({ ...filters, revenue_range: filters.revenue_range === r ? "" : r })}
                                className={`text-[9px] px-2 py-1 rounded border transition-all ${filters.revenue_range === r ? "border-brand-accent bg-[rgba(212,255,0,0.08)] text-brand-accent" : "border-border-subtle text-text-muted hover:text-text-primary"}`}>{r}</button>
                            ))}
                          </div>
                        </div>
                        {/* Company Size Funnel */}
                          ...
                          <div className="flex flex-wrap gap-1">
                            {COMPANY_SIZES.map(s => (
                              <button key={s} onClick={() => setFilters({ ...filters, company_size: filters.company_size === s ? "" : s })}
                                className={`text-[9px] px-2 py-1 rounded border transition-all ${filters.company_size === s ? "border-brand-accent bg-[rgba(212,255,0,0.08)] text-brand-accent" : "border-border-subtle text-text-muted hover:text-text-primary"}`}>{s}</button>
                            ))}
                          </div>
                        </div>
                        {/* Tech Stack Funnel */}
                          ...
                          <div className="flex flex-wrap gap-1">
                            {DECISION_MAKER_TITLES.map(title => (
                              <button key={title} onClick={() => toggleDecisionMakerTitle(title)}
                                className={`text-[9px] px-2 py-1 rounded border transition-all ${decisionMakerTitles.includes(title) ? "border-brand-accent bg-[rgba(212,255,0,0.08)] text-brand-accent" : "border-border-subtle text-text-muted hover:text-text-primary"}`}>
                  ...
                  <div className="glass-indigo rounded-xl p-4">
                    ...
                    {aiMatchEnabled && (
                      <div className="space-y-3 mt-3 pt-3 border-t border-border-subtle">
                        ...
                        {aiMatchPrompt && (
                          <div className="p-2 bg-[rgba(212,255,0,0.05)] border border-[rgba(212,255,0,0.1)] rounded-lg">
                    ...
                    {batchMode ? (
                      ...
                      <>
                        ...
                        <div className="flex flex-wrap gap-1.5 mb-3">
                          {niches.map(n => (
                            <span key={n} className="bg-[rgba(212,255,0,0.08)] border border-[rgba(212,255,0,0.2)] text-brand-accent text-xs px-2.5 py-1 rounded-full flex items-center gap-1.5">
                                ...
                                >
                                  ...
                                  <div className="flex items-center gap-1.5">
                                    {selectedInCategory > 0 && (
                                      <span className="text-[8px] bg-[rgba(212,255,0,0.08)] text-brand-accent px-1.5 py-0.5 rounded-full font-medium">{selectedInCategory} selected</span>
                                    )}
                                ...
                                {isExpanded && (
                                  <div className="flex flex-wrap gap-1 p-2 border-t border-border-subtle">
                                    ...
                                    {items.filter(n => !niches.includes(n)).length === 0 && (
                                      <p className="text-[9px] text-[rgba(212,255,0,0.6)] italic px-1">All niches in this category are selected</p>
                                    )}
                                  </div>
                                )}
                              </div>
                        ...
                        <div key={code}>
                          ...
                          <div className="flex flex-wrap gap-1">
                            ...
                            {cities.length === 0 && !locationSearch.trim() && (
                              <p className="text-[9px] text-[rgba(212,255,0,0.6)] italic px-1">All cities selected</p>
                            )}
                          </div>
                        </div>
                      );
            ...
            {tab === "results" && (
              <div className="space-y-4">
                ...
                {!pushTipDismissed && (
                  <div className="rounded-xl border border-indigo-400/20 bg-indigo-500/5 px-3.5 py-2.5 flex items-start gap-2.5">
                    <div className="w-6 h-6 rounded-lg bg-[rgba(212,255,0,0.10)] border border-[rgba(212,255,0,0.25)] flex items-center justify-center text-brand-accent flex-shrink-0 mt-0.5">
                      <Lightbulb size={12} />
                    </div>
                      ...
                      {results.slice(0, 9).map((r, i) => {
                        ...
                        return (
                          <motion.div
                            ...
                            className={`glass rounded-xl p-4 cursor-pointer transition-all hover:border-[rgba(212,255,0,0.14)] spotlight-card ${selectedLeads.has(i) ? "border-[rgba(212,255,0,0.40)] bg-[rgba(212,255,0,0.05)]" : ""}`}
                          >
                            ...
                            <div className="flex gap-1 mt-2">
                              ...
                              {r.facebook_url && <span className="text-[8px] bg-[rgba(212,255,0,0.08)] text-brand-accent px-1.5 py-0.5 rounded">FB</span>}
                              {r.tiktok_url && <span className="text-[8px] bg-white/8 text-text-secondary px-1.5 py-0.5 rounded">TK</span>}
                              {r.linkedin_url && <span className="text-[8px] bg-[rgba(212,255,0,0.08)] text-brand-accent px-1.5 py-0.5 rounded">LI</span>}
                            </div>
                          </motion.div>
                        );
                      })}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                    {[
                      ...
                      <button key={e.id} onClick={() => setEnrichmentType(e.id)}
                        className={`p-4 rounded-xl border text-left transition-all ${enrichmentType === e.id ? "border-brand-accent bg-[rgba(212,255,0,0.08)]" : "border-border-subtle hover:border-[rgba(212,255,0,0.25)]"}`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {savedSearches.map((s, si) => (
                      <motion.div
                        ...
                        whileHover={{ y: -3 }}
                        onMouseMove={(e) => { const rect = e.currentTarget.getBoundingClientRect(); e.currentTarget.style.setProperty("--mouse-x", `${e.clientX - rect.left}px`); e.currentTarget.style.setProperty("--mouse-y", `${e.clientY - rect.top}px`); }}
                        className="glass rounded-xl p-4 hover:border-[rgba(212,255,0,0.14)] transition-all spotlight-card"
                      >
                        <div className="flex items-start justify-between mb-2">
                          <div>
                        ...
                        <div className="flex flex-wrap gap-1 mb-2">
                          {s.platforms.map(p => <span key={p} className="text-[8px] bg-[rgba(212,255,0,0.08)] text-brand-accent px-1.5 py-0.5 rounded">{p}</span>)}
                  ...
                  <div className="space-y-2">
                    {searchHistory.map((h, hi) => (
                      <motion.div
                        ...
                        className="glass-md rounded-lg p-3 hover:border-[rgba(212,255,0,0.14)] transition-all"
                      >
                        <div className="flex items-center justify-between mb-1.5">
                          <div className="flex flex-wrap gap-1">
                            {h.platforms.map(p => <span key={p} className="text-[8px] bg-[rgba(212,255,0,0.08)] text-brand-accent px-1.5 py-0.5 rounded">{p}</span>)}
                ...
                {showScheduleForm && (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-1 mb-3">
                      {selectedPlatforms.map(p => <span key={p} className="text-[8px] bg-[rgba(212,255,0,0.08)] text-brand-accent px-1.5 py-0.5 rounded">{p}</span>)}
                            ...
                            <button
                              ...
                              className={`flex-1 py-2 rounded-lg text-[10px] font-medium border transition-all ${
                                outreachConfig.start_delay === opt.id
                                  ? "border-brand-accent bg-[rgba(212,255,0,0.10)] text-brand-accent"
                          ...
                          <label
                            ...
                            className={`flex items-center gap-2 p-2.5 rounded-lg border cursor-pointer transition-all ${
                              selectedPushCampaign === c.id
                                ? "border-brand-accent bg-[rgba(212,255,0,0.05)]"
