            ...
            <div className="flex items-center justify-between pt-2 border-t border-border/30">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-xs rounded-md bg-[rgba(37,99,235,0.12)] text-brand-accent border border-[rgba(37,99,235,0.25)] hover:bg-[rgba(37,99,235,0.18)] disabled:opacity-50"
                >
