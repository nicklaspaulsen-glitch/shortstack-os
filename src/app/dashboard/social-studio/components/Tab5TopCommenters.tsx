      ...
      <div className="rounded-xl border border-border-subtle/40 bg-surface p-4">
        ...
        {loading ? (
          ...
          <table className="w-full text-xs">
            ...
            <tbody>
              {commenters.map((c) => (
                <tr key={`${c.platform}:${c.commenter_handle}`} className="border-t border-border-subtle/20 hover:bg-elevated/40">
                  ...
                  <td className="py-2 pl-3 max-w-[280px] truncate text-text-muted" title={c.most_recent_comment}>
        ...
        {active && (
          <div className="px-5 py-4 space-y-3">
            <div className="rounded-md bg-elevated p-3 text-xs">
              <span className="text-[10px] uppercase tracking-wider text-text-muted">Their comment</span>
              <p className="text-text-primary mt-1 leading-relaxed">{active.most_recent_comment}</p>
            </div>
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-border-subtle/30">
              <button
                type="button"
