    ...
    <div className="fade-in space-y-5">
          ...
          {selectedMember && (() => {
            ...
            return (
              <motion.div
                ...
                className="rounded-xl p-4 space-y-4 border border-[rgba(0,0,0,0.08)]" style={{ background: "#FAFAFB", backdropFilter: "blur(16px) saturate(1.5)", WebkitBackdropFilter: "blur(16px) saturate(1.5)" }}
              >
      ...
      {tab === "permissions" && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.2 }}
          className="rounded-xl overflow-x-auto p-4 border border-[rgba(0,0,0,0.08)]" style={{ background: "#FAFAFB", backdropFilter: "blur(16px) saturate(1.5)", WebkitBackdropFilter: "blur(16px) saturate(1.5)" }}
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {ROLE_DEFINITIONS.map((role, index) => (
              <motion.div
                ...
                whileHover={{ y: -3 }}
                style={{ background: "#FAFAFB", backdropFilter: "blur(16px) saturate(1.5)", WebkitBackdropFilter: "blur(16px) saturate(1.5)", border: "1px solid rgba(0,0,0,0.08)", borderRadius: "0.75rem", padding: "1rem", position: "relative", overflow: "hidden" }}
              >
            ...
            <motion.button
              ...
              style={{ background: "#FAFAFB", backdropFilter: "blur(16px) saturate(1.5)", WebkitBackdropFilter: "blur(16px) saturate(1.5)", border: "1px dashed rgba(0,0,0,0.12)", borderRadius: "0.75rem", padding: "1rem" }}
            >
      ...
      {tab === "activity" && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.2 }}
          style={{ background: "#FAFAFB", backdropFilter: "blur(16px) saturate(1.5)", WebkitBackdropFilter: "blur(16px) saturate(1.5)", border: "1px solid rgba(0,0,0,0.08)", borderRadius: "0.75rem", padding: "1rem" }}
        >
