  ...
  return (
    ...
    <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
      <div className="min-w-0">
        <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">Communication Setup</p>
        <h1 className="text-2xl font-display font-bold text-text-primary">Phone Setup</h1>
      </div>
                ...
                <div className="glass rounded-xl p-6">
                  ...
                  {loadingClients ? (
                    ...
                    <div className="rounded-lg border border-dashed border-border-subtle/50 bg-background/30 p-8 text-center">
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 rounded-full bg-brand-accent px-4 py-2 text-xs font-semibold text-[#020711] transition hover:bg-brand-accent/80"
                      >
                  ...
                  <div className="mt-6 flex justify-end">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 rounded-full bg-brand-accent px-4 py-2 text-sm font-semibold text-[#020711] transition hover:bg-brand-accent/80 disabled:cursor-not-allowed disabled:opacity-40"
                    >
                ...
                <div className="glass rounded-xl p-6">
                  ...
                  <div className="flex justify-between">
                    ...
                    <button
                      onClick={provision}
                      disabled={buying}
                      className="inline-flex items-center gap-1.5 rounded-full bg-brand-accent px-5 py-2 text-sm font-semibold text-[#020711] transition hover:bg-brand-accent/80 disabled:opacity-60"
                    >
                      {buying ? (
                        <>
                ...
                <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/5 p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 rounded-full bg-brand-accent px-4 py-2 text-sm font-semibold text-[#020711] transition hover:bg-brand-accent/80 disabled:opacity-60"
                    >
                      {testSending ? (
                        <>
