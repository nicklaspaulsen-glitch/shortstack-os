    ...
    >
      ...
      <span
        className={`rounded px-1.5 py-0.5 text-[10px] ${
          isActive ? "bg-[rgba(212,255,0,0.12)] text-brand-accent" : "bg-surface-light text-text-muted"
        }`}
      >
        {count}
      </span>
...
function FontCard({
  ...
  return (
    <div className="group rounded-lg border border-border-subtle/50 bg-surface-light/30 p-3 transition hover:border-[rgba(212,255,0,0.4)]">
...
function TransitionCard({
  ...
  return (
    <div className="rounded-lg border border-border-subtle/50 bg-surface-light/30 p-3 transition hover:border-[rgba(212,255,0,0.4)]">
      <div className="mb-2 flex items-start justify-between gap-2">
        <div className="min-w-0">
      ...
      >
        <div
          key={k}
          className={`absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[rgba(212,255,0,0.3)] to-red-500/30 text-xs font-semibold text-text-primary ${
...
function AudioCard({
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border border-border-subtle/50 bg-surface-light/30 p-3 transition hover:border-[rgba(212,255,0,0.4)]">
      <button
        onClick={toggle}
        disabled={error}
        className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full transition ${
          error
            ...
            : playing
              ...
              : "bg-[rgba(212,255,0,0.12)] text-brand-accent hover:bg-[rgba(212,255,0,0.18)]"
        }`}
