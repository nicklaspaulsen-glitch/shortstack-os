      ...
      <div className="p-6 pb-2 min-w-0">
        ...
        <div className="flex items-center justify-between gap-4 mb-5">
          <div className="min-w-0">
            <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">Autonomous Outreach</p>
            <h1 className="text-2xl font-display font-bold text-text-primary">Lead Pipeline</h1>
          </div>
