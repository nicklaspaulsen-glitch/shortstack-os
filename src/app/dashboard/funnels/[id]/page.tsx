...
export default function FunnelCanvasPage() {
  ...
  if (loading) {
    return (
      <MotionPage className="max-w-7xl mx-auto space-y-6"><div className="h-32  bg-white/4 animate-pulse" /><div className="flex gap-4">
    ...
    <div className="space-y-5 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">FUNNEL.NAME</p>
          <h1 className="text-2xl font-display font-bold text-text-primary">{funnel.name}</h1>
        </div>
