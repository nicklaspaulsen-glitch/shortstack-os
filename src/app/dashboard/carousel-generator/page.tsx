    ...
    <MotionPage className="max-w-7xl mx-auto animate-fade-in"><CarouselWizard
            ...
            <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
              <div className="min-w-0">
                <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">Visual Carousels</p>
                <h1 className="text-2xl font-display font-bold text-text-primary">Carousel Generator</h1>
              </div>
                  ...
                  {slides.length > 0 && (
                    <>
                      <button
                        ...
                        className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border border-border-subtle bg-white/5 text-text-primary hover:bg-white/10 transition-all"
                      >
