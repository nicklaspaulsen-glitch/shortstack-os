...
>
                ...
                <button
                  onClick={openCreate}
                  className="px-4 py-2 rounded-lg bg-[rgba(212, 255, 0,0.08)] hover:bg-[rgba(212, 255, 0,0.14)] text-brand-accent text-sm font-medium transition-colors"
>
                ...
                {(
                  ...
                  <div key={key}>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-[rgba(0,0,0,0.08)] bg-white px-3 py-2 text-[#111827] text-sm focus:outline-none focus:border-[rgba(212, 255, 0,0.40)]"
 />
                  </div>
                ))}
