      ...
      <div className="flex items-center gap-2 shrink-0">
        <div className="flex items-center gap-2 bg-black/5 border border-border-subtle rounded-xl p-1">
                  ...
                  <motion.div
                    ...
                    className={`relative glass rounded-xl border p-5 flex flex-col transition-shadow ${
                      isRecommended
                        ...
                        : isCurrent
                        ? "border-[rgba(212, 255, 0,0.25)] bg-[rgba(212, 255, 0,0.03)] ring-1 ring-[rgba(212, 255, 0,0.1)]"
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-center gap-1.5 py-2 rounded-xl text-xs font-semibold transition-all ${
                        isCurrent
                          ? "bg-[rgba(212, 255, 0,0.08)] text-brand-accent border border-[rgba(212, 255, 0,0.2)] cursor-default"
                          : isRecommended
                          ? "bg-emerald-500 text-white hover:bg-emerald-600 shadow-sm"
                          : isUpgrade
                          ? "bg-brand-accent text-white hover:bg-brand-accent/80 shadow-sm"
                          : "bg-surface-light text-text-primary border border-border-subtle hover:bg-[rgba(212, 255, 0,0.08)] hover:text-brand-accent"
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-surface-light text-text-primary text-xs font-medium border border-border-subtle hover:bg-[rgba(212, 255, 0,0.08)] hover:text-brand-accent transition-colors"
              >
                View billing & usage
                <ArrowUpRight size={12} />
              </Link>
