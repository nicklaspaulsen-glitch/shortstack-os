...
export default function VoiceProfileSettingsPage() {
  ...
  return (
    <MotionPage className="space-y-6 max-w-5xl mx-auto">{/* -- Voice Profile command strip -- */}
    <div className="flex items-center justify-between gap-4 px-1 py-3 sm:py-4">
      <div className="min-w-0">
        <p className="text-xs uppercase tracking-[0.2em] text-text-muted font-editorial italic mb-1">Voice Settings</p>
        <h1 className="text-2xl font-display font-bold text-text-primary">Voice Profile</h1>
      </div>
