        ...
        <h1 className="text-2xl font-display font-bold text-text-primary">Referrals & commissions</h1>
            ...
            >
                ...
                {shareLinks && (
                  <div className="flex items-center gap-1.5">
                    <a
                      ...
                      className="w-9 h-9 rounded-xl bg-surface border border-border-subtle flex items-center justify-center text-text-muted hover:text-brand-accent hover:border-[rgba(212,255,0,0.25)] transition-colors"
              ...
              <div className="glass rounded-xl overflow-hidden">
                <div className="px-5 py-3.5 border-b border-border-subtle flex items-center gap-2">
                  ...
                  {leaderboard?.is_admin_view && (
                    <span className="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded-full bg-[rgba(212,255,0,0.08)] text-brand-accent">
                      Admin
                    </span>
                  )}
                </div>
              ...
              <a
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-surface-light text-text-primary text-xs font-medium border border-border-subtle hover:bg-[rgba(212,255,0,0.08)] hover:text-brand-accent transition-colors shrink-0"
              >
  ...
  return (
    <div
      className={`flex items-center gap-3 px-3 py-2 rounded-xl transition-colors ${
        entry.is_you ? "bg-[rgba(212,255,0,0.08)] border border-[rgba(212,255,0,0.10)]" : "bg-surface-light/30"
      }`}
    >
