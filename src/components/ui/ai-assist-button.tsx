        ...
        >
          <div className="p-3">
            ...
            <textarea
              ...
              rows={2}
              className="w-full bg-card border border-border-subtle rounded-md px-2 py-1.5 text-[11px] text-text-primary placeholder:text-text-muted/60 focus:outline-none focus:border-[rgba(212,255,0,0.4)] mb-2 resize-none"
              autoFocus
            />
