    ...
    <div className={`card space-y-4 ${className}`}>
      {!compact && (
        <div className="flex items-start gap-3">
          <div className="w-9 h-9 rounded-lg bg-[rgba(37,99,235,0.08)] flex items-center justify-center text-[#2563EB] shrink-0">
            <Globe size={16} />
          </div>
          ...
          {ai.services.length > 0 && (
            <div className="md:col-span-2">
              ...
              <div className="flex flex-wrap gap-1.5">
                {ai.services.map((s, i) => (
                  <span key={i} className="text-[10px] px-2 py-0.5 rounded-full bg-[rgba(37,99,235,0.08)] text-[#2563EB] border border-[rgba(37,99,235,0.2)]">
                    {s}
                  </span>
                ))}
              </div>
          ...
          <div className="flex flex-wrap gap-1.5">
            {x.socialLinks.map((s, i) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-[10px] px-2 py-0.5 rounded-md bg-surface border border-border hover:border-[rgba(37,99,235,0.25)] capitalize"
              >
                {s.platform}
              </a>
            ))}
