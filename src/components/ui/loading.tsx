  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 gap-3">
      <div className="relative">
        <div className="w-8 h-8 border-2 border-[rgba(212,255,0,0.2)] border-t-[#2563EB] rounded-full animate-spin" />
...
export function InlineLoading() {
  return (
    <div className="flex items-center gap-2 py-2">
      <div className="w-4 h-4 border-2 border-[rgba(212,255,0,0.2)] border-t-[#2563EB] rounded-full animate-spin" />
