  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-text-muted">
      ...
      <g filter={`url(#${id}-soft-shadow)`}>
        ...
        <path d="M100 130 L120 150 L125 135 Z" fill="#CC1A1A" />
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-text-muted">
      ...
      <g filter={`url(#${id}-soft-shadow)`} transform="rotate(45 120 80)">
        ...
        <path d="M135 100 L145 120 L135 115 Z" fill="#CC1A1A" />
        {/* Flame */}
    ...
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-text-muted">
      ...
      <g filter={`url(#${id}-soft-shadow)`}>
        ...
        {[0,1,2,3,4].map(r => [0,1,2,3,4,5].map(c => (
          <circle key={`${r}-${c}`} cx={54 + c*18} cy={96 + r*14} r="3.5" fill="#D4FF00" opacity={r*5+c === 8 ? 1 : 0.18} />
        )))}
      </g>
      {/* Sparkle */}
      <g>
