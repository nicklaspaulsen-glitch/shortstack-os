  ...
  if (minimized) {
    return (
      <div
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-full bg-surface border border-[rgba(59,130,246,0.2)] text-xs text-[#2563EB] hover:bg-surface-light transition-all cursor-grab active:cursor-grabbing touch-none select-none"
      >
    ...
    <div style={panelStyle} className="w-[380px] max-h-[500px] flex flex-col bg-surface border border-border/50  shadow-2xl shadow-black/40 overflow-hidden fade-in">
      ...
      <form onSubmit={(e) => { e.preventDefault(); sendMessage(); }}
        ...
        <button type="submit" disabled={!input.trim() || thinking}
          className="w-7 h-7 rounded-lg bg-[rgba(59,130,246,0.08)] flex items-center justify-center text-[#2563EB] disabled:opacity-30 hover:bg-[rgba(59,130,246,0.12)] transition-colors">
          <Send size={12} />
        </button>
      </form>
