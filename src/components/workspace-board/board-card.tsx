  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 text-[11px] text-text-muted">
        ...
        {assignee && (
          <div
            className="shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold bg-[rgba(59,130,246,0.12)] text-[#2563EB] border border-[rgba(59,130,246,0.3)]"
