...
export function BoardCard({
  ...
  return (
    <motion.div
      ...
      onDragEnd={onDragEnd}
      onClick={onClick}
      className={`relative p-3 rounded-lg bg-surface-light border border-border-subtle hover:border-[rgba(212,255,0,0.3)] transition-colors cursor-grab active:cursor-grabbing ${
