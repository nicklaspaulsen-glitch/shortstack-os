          ...
          <button
            ...
            className={
              connected
                ...
                : "group relative overflow-hidden p-3 rounded-xl bg-surface-light/60 border border-border-subtle hover:border-[rgba(212,255,0,0.4)] hover:bg-surface-light transition text-xs"
            }
