            ...
            <button
              ...
              className={
                connected
                  ...
                  : "flex items-center gap-1 text-[10px] px-2 py-1 rounded-full bg-surface-light border border-border-subtle hover:border-[rgba(59,130,246,0.4)] hover:text-foreground text-text-muted transition"
              }
            >
          ...
          <button
            ...
            className={
              connected
                ...
                : "group relative overflow-hidden p-3 rounded-xl bg-surface-light/60 border border-border-subtle hover:border-[rgba(59,130,246,0.4)] hover:bg-surface-light transition text-xs"
            }
