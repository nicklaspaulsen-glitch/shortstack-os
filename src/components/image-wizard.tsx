    ...
    return (
      <FullModal onClose={onClose}>
        <div className="flex flex-col items-center justify-center py-16 px-6">
          <div className="w-20 h-20  bg-gradient-to-br from-[rgba(37,99,235,0.12)] to-amber-500/10 flex items-center justify-center mb-4">
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5">
      <div className="flex items-center gap-3 text-[11px]">
        <span className="px-2 py-1 rounded-full bg-[rgba(37,99,235,0.08)] text-[#2563EB] border border-[rgba(37,99,235,0.25)] font-semibold uppercase tracking-wider">
      ...
      <div>
        ...
        <textarea
          ...
          rows={5}
          className="w-full px-4 py-3 rounded-xl bg-surface-light border border-border text-sm focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[rgba(37,99,235,0.12)] resize-none font-mono"
        />
      ...
      <div>
        ...
        <textarea
          ...
          rows={2}
          className="w-full px-4 py-3 rounded-xl bg-surface-light border border-border text-xs focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[rgba(37,99,235,0.12)] resize-none font-mono"
        />
      </div>

      {build?.notes && (
        <div className="text-[11px] text-muted italic border-l-2 border-[rgba(37,99,235,0.25)] pl-3">{build.notes}</div>
      )}

      <button
        onClick={onGenerate}
        className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-[#2563EB] to-amber-500 text-white text-sm font-semibold hover:shadow-lg hover:shadow-[rgba(37,99,235,0.18)] transition-all"
      >
...
function CarouselSetup({
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5">
      <div className="bg-[rgba(37,99,235,0.05)] border border-[rgba(37,99,235,0.2)] rounded-xl p-4">
      ...
      <div className="space-y-2">
        {subjects.map((s, i) => (
          <div key={i} className="flex gap-2 items-start">
            <span className="w-6 h-6 rounded-full bg-[rgba(37,99,235,0.08)] text-[#2563EB] text-[10px] font-bold flex items-center justify-center mt-2.5 shrink-0">
              {i + 1}
            </span>
            <textarea
              value={s}
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-[#2563EB] hover:bg-[rgba(37,99,235,0.08)] disabled:opacity-40"
        >
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-[#2563EB] to-amber-500 text-white text-sm font-semibold hover:shadow-lg hover:shadow-[rgba(37,99,235,0.18)] transition-all disabled:opacity-40"
      >
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-3 border-t border-border bg-surface-light/30 flex items-center gap-2">
        ...
        <button
          onClick={onClose}
          className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-gradient-to-r from-[#2563EB] to-amber-500 text-white text-xs font-semibold hover:shadow-lg hover:shadow-[rgba(37,99,235,0.18)]"
        >
