  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5">
      <div className="flex items-center gap-3 text-[11px]">
        <span className="px-2 py-1 rounded-full bg-[rgba(212,255,0,0.08)] text-[#D4FF00] border border-[rgba(212,255,0,0.25)] font-semibold uppercase tracking-wider">
      ...
      <div>
        ...
        <textarea
          ...
          rows={5}
          className="w-full px-4 py-3 rounded-xl bg-surface-light border border-border-subtle text-sm focus:outline-none focus:border-[#D4FF00] focus:ring-2 focus:ring-[rgba(212,255,0,0.12)] resize-none font-mono"
        />
      ...
      <div>
        ...
        <textarea
          ...
          rows={2}
          className="w-full px-4 py-3 rounded-xl bg-surface-light border border-border-subtle text-xs focus:outline-none focus:border-[#D4FF00] focus:ring-2 focus:ring-[rgba(212,255,0,0.12)] resize-none font-mono"
        />
      </div>
    ...
    <div className="max-w-2xl mx-auto space-y-5">
      ...
      <div className="space-y-2">
        {subjects.map((s, i) => (
          <div key={i} className="flex gap-2 items-start">
            <span className="w-6 h-6 rounded-full bg-[rgba(212,255,0,0.08)] text-[#D4FF00] text-[10px] font-bold flex items-center justify-center mt-2.5 shrink-0">
              {i + 1}
            </span>
            <textarea
              value={s}
              ...
              rows={2}
              className="flex-1 px-3 py-2 rounded-lg bg-surface-light border border-border-subtle text-sm focus:outline-none focus:border-[#D4FF00] resize-none"
            />
            {subjects.length > 1 && (
              <button
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-[#D4FF00] hover:bg-[rgba(212,255,0,0.08)] disabled:opacity-40"
        >
