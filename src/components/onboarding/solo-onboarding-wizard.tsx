        ...
        {stepIdx < STEPS.length - 1 ? (
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={next}
              disabled={!canAdvance()}
              className="flex items-center gap-1.5 px-5 py-2 rounded-lg bg-gradient-to-r from-[#2563EB] to-[#3B82F6] text-white text-xs font-bold hover:shadow-lg hover:shadow-[rgba(212,255,0,0.2)] transition-all disabled:opacity-40 disabled:cursor-not-allowed"
            >
          ...
          <button
            ...
            disabled={submitting}
            className="flex items-center gap-1.5 px-5 py-2 rounded-lg bg-gradient-to-r from-[#2563EB] to-[#3B82F6] text-white text-xs font-bold hover:shadow-lg hover:shadow-[rgba(212,255,0,0.2)] transition-all disabled:opacity-50"
          >
          ...
          return (
            <button
              ...
              className={`relative text-left p-4  border transition-all hover-lift ${
                isSelected
                  ? "border-[#2563EB] bg-[rgba(212,255,0,0.08)] shadow-[0_0_0_2px_rgba(212,255,0,0.18)]"
              ...
              <div className="flex items-center gap-2 mb-2">
                <div
                  className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 ${
                    isSelected ? "bg-[rgba(212,255,0,0.12)] text-[#2563EB]" : "bg-surface-light text-text-muted"
                  }`}
                >
                  <Icon size={18} />
                </div>
      ...
      <div className="space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 rounded-xl bg-surface-light border border-border-subtle text-sm focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[rgba(212,255,0,0.2)] transition-all"
          />
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 px-4 py-2.5 rounded-xl bg-surface-light border border-border-subtle text-sm focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[rgba(212,255,0,0.2)] transition-all"
            />
          </div>
        </div>
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-[11px] border transition-all ${
                  sel
                    ? "bg-[rgba(212,255,0,0.08)] border-[rgba(212,255,0,0.4)] text-[#2563EB]"
    ...
    return (
      <div>
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-4 py-2.5 rounded-xl bg-surface-light border border-border-subtle text-sm focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[rgba(212,255,0,0.2)] transition-all resize-none"
        />
      </div>
    );
  }
          ...
          {questions.map((q) => (
            <div key={q.id} className="rounded-xl border border-border-subtle p-4 bg-surface-light/30">
              ...
              <textarea
                ...
                placeholder={q.placeholder}
                rows={2}
                className="w-full px-3 py-2.5 bg-surface-light border border-border-subtle rounded-lg text-sm text-text-primary focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[rgba(212,255,0,0.2)] transition-all resize-none"
              />
            </div>
          ))}
