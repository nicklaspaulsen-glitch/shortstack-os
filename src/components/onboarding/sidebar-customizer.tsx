    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          type="button"
          onClick={selectAll}
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface-light border border-border-subtle text-xs font-medium text-text-muted hover:text-text-primary hover:border-[rgba(212,255,0,0.25)] transition-all"
        >
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center justify-between gap-2 px-2.5 py-1.5 rounded-lg text-xs text-left transition-all ${
                        selected
                          ? "bg-[rgba(212,255,0,0.08)] border border-[rgba(212,255,0,0.25)] text-text-primary"
