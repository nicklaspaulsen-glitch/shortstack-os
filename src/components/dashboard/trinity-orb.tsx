...
export default function TrinityOrb({ firstName, clientId = null, suggestions = DEFAULT_SUGGESTIONS }: Props) {
  ...
  return (
    <div className="card-static overflow-hidden relative" style={{ borderColor: "rgba(212,255,0,0.18)" }}>
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 opacity-60">
        <div className="absolute top-[-60px] left-1/2 -translate-x-1/2 w-[500px] h-[280px] rounded-full blur-3xl"
             style={{ background: "radial-gradient(ellipse, rgba(212,255,0,0.20), transparent 60%)" }} />
        ...
        <div className="absolute top-[120px] right-[20%] w-[160px] h-[160px] rounded-full blur-3xl"
             style={{ background: "radial-gradient(circle, rgba(212,255,0,0.12), transparent 70%)" }} />
      </div>
      ...
      <div className="relative px-4 sm:px-6 pb-4">
        ...
        >
          <div className="flex-1 relative  border border-[rgba(212,255,0,0.2)] bg-surface focus-within:border-[rgba(212,255,0,0.5)] focus-within:shadow-[0_0_0_3px_rgba(212,255,0,0.12)] transition-all">
            <textarea
              ref={inputRef}
              value={input}
