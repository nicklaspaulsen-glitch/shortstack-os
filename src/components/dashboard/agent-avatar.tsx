...
const STATUS_COLORS: Record<AgentStatus, { glow: string; accent: string }> = {
  idle:     { glow: "rgba(212, 255, 0, 0.3)",   accent: "#D4FF00" },
  working:  { glow: "rgba(212, 255, 0, 0.45)",  accent: "#D4FF00" },
  ...
  switch (face) {
    ...
    case "cyborg":
      return (
        <>
          ...
          <circle cx="38" cy="48" r="2" fill={eyesActive ? "#D4FF00" : "#888"} />
          {/* Robot eye */}
    ...
    case "wizard":
      return (
        <>
          {/* Hat */}
          <path d="M 30 36 L 50 8 L 70 36 Z" fill="#D4FF00" />
          ...
          {/* Hat brim */}
          <ellipse cx="50" cy="36" rx="22" ry="4" fill="#AACC00" />
          {/* Face */}
