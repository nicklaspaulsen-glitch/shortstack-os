...
const navItems: NavItem[] = [
  ...
  { label: "Voicemail Drop", href: "/dashboard/voicemail-drop", icon: <NavIcon3D name="Phone" size={16} />, roles: ["admin"], sub: "Leads & Outreach", tier: 3, settingsOnly: true },
  { label: "Voice Studio", href: "/dashboard/voice-studio", icon: <NavIcon3D name="Mic" size={16} />, roles: ["admin", "team_member"], sub: "Leads & Outreach", tier: 3, settingsOnly: true },
  { label: "DM Controller", href: "/dashboard/dm-controller", icon: <NavIcon3D name="Send" size={16} />, roles: ["admin"], sub: "Leads & Outreach", tier: 3, settingsOnly: true },
  { label: "Conversations", href: "/dashboard/conversations", icon: <NavIcon3D name="MessagesSquare" size={16} />, roles: ["admin"], sub: "Leads & Outreach", tier: 3, settingsOnly: true },
  { label: "Outreach Feed", href: "/dashboard/outreach-feed", icon: <NavIcon3D name="MessagesSquare" size={16} />, roles: ["admin", "team_member"], sub: "Leads & Outreach", tier: 3, settingsOnly: true },
  { label: "Sales Coach", href: "/dashboard/coach", icon: <NavIcon3D name="Award" size={16} />, roles: ["admin", "team_member"], sub: "Leads & Outreach", tier: 3, settingsOnly: true },
  { label: "Outreach Logs", href: "/dashboard/outreach-logs", icon: <NavIcon3D name="ClipboardList" size={16} />, roles: ["admin"], sub: "Leads & Outreach", tier: 3, settingsOnly: true },
  ...
  { label: "Tags", href: "/dashboard/tags", icon: <NavIcon3D name="Layers" size={16} />, roles: ["admin"], sub: "Pipeline", tier: 3, settingsOnly: true },
  ...
  { label: "Commissions", href: "/dashboard/commission-tracker", icon: <NavIcon3D name="Award" size={16} />, roles: ["admin"], sub: "Pipeline", tier: 3, settingsOnly: true },
  ...
  { label: "Scheduling", href: "/dashboard/scheduling", icon: <NavIcon3D name="Calendar" size={16} />, roles: ["admin", "team_member"], sub: "Scheduling", tier: 3, settingsOnly: true },
  { label: "Meetings", href: "/dashboard/meetings", icon: <NavIcon3D name="Calendar" size={16} />, roles: ["admin", "team_member"], sub: "Scheduling", tier: 3, settingsOnly: true },
  { label: "Courses", href: "/dashboard/courses", icon: <NavIcon3D name="BookOpen" size={16} />, roles: ["admin"], sub: "Membership", tier: 3, settingsOnly: true },
  ...
  { label: "Email Composer", href: "/dashboard/email-composer", icon: <NavIcon3D name="Mail" size={16} />, roles: ["admin", "team_member"], sub: "Writing", tier: 3, settingsOnly: true },
  { label: "Email Templates", href: "/dashboard/email-templates", icon: <NavIcon3D name="MailPlus" size={16} />, roles: ["admin"], sub: "Writing", tier: 3, settingsOnly: true },
  { label: "SMS Templates", href: "/dashboard/sms-templates", icon: <NavIcon3D name="Smartphone" size={16} />, roles: ["admin"], sub: "Writing", tier: 3, settingsOnly: true },
  ...
  { label: "A/B Tests", href: "/dashboard/ab-tests", icon: <NavIcon3D name="FlaskConical" size={16} />, roles: ["admin"], sub: "Brand & Web", tier: 3, settingsOnly: true },
  { label: "Forms", href: "/dashboard/forms", icon: <NavIcon3D name="ClipboardCheck" size={16} />, roles: ["admin", "team_member"], sub: "Brand & Web", tier: 3, settingsOnly: true },
  { label: "Intake Forms", href: "/dashboard/intake", icon: <NavIcon3D name="Zap" size={16} />, roles: ["admin"], sub: "Brand & Web", tier: 2 },
  { label: "Surveys", href: "/dashboard/surveys", icon: <NavIcon3D name="ClipboardList" size={16} />, roles: ["admin"], sub: "Brand & Web", tier: 3, settingsOnly: true },
  { label: "Social Studio", href: "/dashboard/social-studio", icon: <NavIcon3D name="Sparkles" size={16} />, roles: ["admin", "team_member"], sub: "Social", tier: 3, settingsOnly: true },
  ...
  { label: "Agent Controls", href: "/dashboard/agent-controls", icon: <NavIcon3D name="SlidersHorizontal" size={16} />, roles: ["admin"], sub: "AI", tier: 3, settingsOnly: true },
  { label: "Apps", href: "/dashboard/agent-desktop", icon: <NavIcon3D name="Monitor" size={16} />, roles: ["admin", "team_member"], sub: "AI", tier: 3, settingsOnly: true },
  ...
  { label: "Triggers", href: "/dashboard/triggers", icon: <NavIcon3D name="Zap" size={16} />, roles: ["admin"], sub: "Workflows", tier: 3, settingsOnly: true },
  ...
  { label: "WhatsApp", href: "/dashboard/whatsapp", icon: <NavIcon3D name="MessageSquare" size={16} />, roles: ["admin"], sub: "Channels", tier: 3, settingsOnly: true },
  ...
  { label: "Board", href: "/dashboard/workspace/board", icon: <NavIcon3D name="Kanban" size={16} />, roles: ["admin", "team_member"], section: "Workspace", sub: "Team", tier: 3, settingsOnly: true },
  { label: "Whiteboard", href: "/dashboard/workspace/whiteboard", icon: <NavIcon3D name="LayoutGrid" size={16} />, roles: ["admin", "team_member"], sub: "Team", tier: 3, settingsOnly: true },
  { label: "Files", href: "/dashboard/workspace/files", icon: <NavIcon3D name="FolderOpen" size={16} />, roles: ["admin", "team_member"], sub: "Team", tier: 3, settingsOnly: true },

  // ── Manage (operations & finance) ──
  { label: "Workspaces", href: "/dashboard/workspaces", icon: <NavIcon3D name="Building2" size={16} />, roles: ["admin"], section: "Manage", sub: "Business", tier: 3, settingsOnly: true },
  { label: "Team", href: "/dashboard/team", icon: <NavIcon3D name="UsersRound" size={16} />, roles: ["admin"], sub: "Business", tier: 2 },
  { label: "Production", href: "/dashboard/production", icon: <NavIcon3D name="Kanban" size={16} />, roles: ["admin", "team_member"], sub: "Business", tier: 3, settingsOnly: true },
  { label: "Projects", href: "/dashboard/projects", icon: <NavIcon3D name="Kanban" size={16} />, roles: ["admin", "team_member"], sub: "Business", tier: 3, settingsOnly: true },
  { label: "Financials", href: "/dashboard/financials", icon: <NavIcon3D name="BarChart3" size={16} />, roles: ["admin"], sub: "Business", tier: 3, settingsOnly: true },
  { label: "Invoices", href: "/dashboard/invoices", icon: <NavIcon3D name="Receipt" size={16} />, roles: ["admin"], sub: "Business", tier: 2 },
  { label: "Invoice Templates", href: "/dashboard/invoice-templates", icon: <NavIcon3D name="FileText" size={16} />, roles: ["admin"], sub: "Business", tier: 3, settingsOnly: true },
  ...
  { label: "Client Health", href: "/dashboard/client-health", icon: <NavIcon3D name="Heart" size={16} />, roles: ["admin"], sub: "Support", tier: 3, settingsOnly: true },
  { label: "Reviews", href: "/dashboard/reviews", icon: <NavIcon3D name="Star" size={16} />, roles: ["admin"], sub: "Support", tier: 3, settingsOnly: true },
  { label: "Tickets", href: "/dashboard/tickets", icon: <NavIcon3D name="LifeBuoy" size={16} />, roles: ["admin"], sub: "Support", tier: 3, settingsOnly: true },
  { label: "Referrals", href: "/dashboard/referrals", icon: <NavIcon3D name="Gift" size={16} />, roles: ["admin"], sub: "Support", tier: 3, settingsOnly: true },
  { label: "ROI Calculator", href: "/dashboard/roi-calculator", icon: <NavIcon3D name="Calculator" size={16} />, roles: ["admin"], sub: "Support", tier: 3, settingsOnly: true },
  { label: "Monitor", href: "/dashboard/monitor", icon: <NavIcon3D name="Activity" size={16} />, roles: ["admin"], sub: "Tools", tier: 3, settingsOnly: true },
  { label: "Reports Gen", href: "/dashboard/report-generator", icon: <NavIcon3D name="FileBarChart2" size={16} />, roles: ["admin"], sub: "Tools", tier: 3, settingsOnly: true },
  { label: "Marketplace", href: "/dashboard/marketplace", icon: <NavIcon3D name="Store" size={16} />, roles: ["admin"], sub: "Tools", tier: 3, settingsOnly: true },
