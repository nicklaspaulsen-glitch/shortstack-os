...
const navItems: NavItem[] = [
  ...
  { label: "Content Plan",   href: "/dashboard/content-plan",     icon: <NavIcon3D name="Calendar"  size={16} />, roles: ["admin", "team_member"],                   tier: 2 },
  ...
  // ── Manage ──
  { label: "Team",     href: "/dashboard/team",     icon: <NavIcon3D name="UsersRound" size={16} />, roles: ["admin"],                tier: 2, section: "Manage" },
  ...
  { label: "CRM",              href: "/dashboard/crm",               icon: <NavIcon3D name="Users"           size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  ...
  { label: "Voice Studio",     href: "/dashboard/voice-studio",      icon: <NavIcon3D name="Mic"             size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "DM Controller",    href: "/dashboard/dm-controller",     icon: <NavIcon3D name="Send"            size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Conversations",    href: "/dashboard/conversations",      icon: <NavIcon3D name="MessagesSquare" size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Outreach Feed",    href: "/dashboard/outreach-feed",     icon: <NavIcon3D name="MessagesSquare" size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Sales Coach",      href: "/dashboard/coach",             icon: <NavIcon3D name="Award"           size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Outreach Logs",    href: "/dashboard/outreach-logs",     icon: <NavIcon3D name="ClipboardList"  size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Cold Email",       href: "/dashboard/cold-email",        icon: <NavIcon3D name="MailPlus"        size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Sequences",        href: "/dashboard/sequences",         icon: <NavIcon3D name="ListOrdered"     size={16} />, roles: ["admin"],                                   settingsOnly: true },
  ...
  { label: "Proposals",        href: "/dashboard/proposals",         icon: <NavIcon3D name="FileCheck"       size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Trinity",          href: "/dashboard/trinity",           icon: <NavIcon3D name="Zap"             size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Forecast",         href: "/dashboard/forecast",          icon: <NavIcon3D name="TrendingUp"      size={16} />, roles: ["admin"],                                   settingsOnly: true },
  ...
  { label: "Email Templates",  href: "/dashboard/email-templates",   icon: <NavIcon3D name="MailPlus"        size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "SMS Templates",    href: "/dashboard/sms-templates",     icon: <NavIcon3D name="Smartphone"      size={16} />, roles: ["admin"],                                   settingsOnly: true },
  ...
  { label: "Websites",         href: "/dashboard/websites",          icon: <NavIcon3D name="Globe"           size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Landing Pages",    href: "/dashboard/landing-pages",     icon: <NavIcon3D name="LayoutTemplate"  size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Funnels",          href: "/dashboard/funnels",           icon: <NavIcon3D name="GitBranch"       size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Forms & Surveys",  href: "/dashboard/forms",             icon: <NavIcon3D name="ClipboardCheck"  size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Intake Forms",     href: "/dashboard/intake",            icon: <NavIcon3D name="Zap"             size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Social Studio",    href: "/dashboard/social-studio",     icon: <NavIcon3D name="Sparkles"        size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Design Studio",    href: "/dashboard/design-studio",     icon: <NavIcon3D name="PenTool"         size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Carousel Gen",     href: "/dashboard/carousel-generator",icon: <NavIcon3D name="Layers"          size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Preset Library",   href: "/dashboard/video-editor/library", icon: <NavIcon3D name="LayoutTemplate" size={16} />, roles: ["admin", "founder", "agency", "team_member"], settingsOnly: true },
  { label: "AI Agents",        href: "/dashboard/services",          icon: <NavIcon3D name="Sparkles"        size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Agent Office",     href: "/dashboard/agent-office",      icon: <NavIcon3D name="UsersRound"      size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Workflows",        href: "/dashboard/workflows",         icon: <NavIcon3D name="Zap"             size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Flow Builder",     href: "/dashboard/workflow-builder",  icon: <NavIcon3D name="GitBranch"       size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Automations",      href: "/dashboard/automations",       icon: <NavIcon3D name="RotateCcw"       size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "WhatsApp",         href: "/dashboard/whatsapp",          icon: <NavIcon3D name="MessageSquare"   size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Board",            href: "/dashboard/workspace/board",   icon: <NavIcon3D name="Kanban"          size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Whiteboard",       href: "/dashboard/workspace/whiteboard", icon: <NavIcon3D name="LayoutGrid"  size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  ...
  { label: "Workspaces",       href: "/dashboard/workspaces",        icon: <NavIcon3D name="Building2"       size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Production",       href: "/dashboard/production",        icon: <NavIcon3D name="Kanban"          size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Projects",         href: "/dashboard/projects",          icon: <NavIcon3D name="Kanban"          size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Financials",       href: "/dashboard/financials",        icon: <NavIcon3D name="BarChart3"       size={16} />, roles: ["admin"],                                   settingsOnly: true },
  { label: "Invoices",         href: "/dashboard/invoices",          icon: <NavIcon3D name="Receipt"         size={16} />, roles: ["admin"],                                   settingsOnly: true },
  ...
  { label: "Subaccounts",      href: "/dashboard/subaccounts",       icon: <NavIcon3D name="Building2"       size={16} />, roles: ["admin"],                                   settingsOnly: true },
  ...
  { label: "Usage & Tokens",   href: "/dashboard/usage",             icon: <NavIcon3D name="Zap"             size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  ...
  { label: "Mail Setup",       href: "/dashboard/mail-setup",        icon: <NavIcon3D name="Mail"            size={16} />, roles: ["admin", "founder", "agency", "team_member"], settingsOnly: true },
  { label: "Domains",          href: "/dashboard/domains",           icon: <NavIcon3D name="Globe2"          size={16} />, roles: ["admin"],                                   settingsOnly: true },
  ...
  { label: "Download Desktop", href: "/dashboard/download",          icon: <NavIcon3D name="Download"        size={16} />, roles: ["admin", "team_member"],                    settingsOnly: true },
  { label: "Integrations Hub", href: "/dashboard/integrations-hub",  icon: <NavIcon3D name="Plug"            size={16} />, roles: ["admin"],                                   settingsOnly: true },
  ...
  { label: "Activity Log",     href: "/dashboard/activity-log",      icon: <NavIcon3D name="ClipboardList"   size={16} />, roles: ["admin"],                                   settingsOnly: true },
