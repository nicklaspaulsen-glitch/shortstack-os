...
const AGENT_CONFIGS = [
  ...
  { id: "outreach", name: "Echo", role: "Outreach Agent", color: "#FF6B6B", headColor: "#bae6fd", message: "Sending cold DMs..." },
  { id: "content", name: "Pixel", role: "Content Writer", color: "#f43f5e", headColor: "#fecdd3", message: "Writing viral script..." },
  { id: "social", name: "Wave", role: "Social Manager", color: "#FF2D2D", headColor: "#FFB3B3", message: "Scheduling posts..." },
  ...
  { id: "ai_receptionist", name: "Ring", role: "Cold Caller", color: "#FF2D2D", headColor: "#99f6e4", message: "Dialing leads..." },
];
...
export default function PixelOffice() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      ctx.fillStyle = working === agents.length ? "#FF2D2D" : "#64748b";
      ...
      agents.forEach(agent => {
        ...
        const statusColor = agent.status === "working" ? "#FF2D2D" : agent.status === "error" ? "#f43f5e" : agent.status === "talking" ? "#C9A84C" : "#475569";
