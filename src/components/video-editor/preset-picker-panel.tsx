...
// Mixkit video CDN links — all royalty-free, no attribution required. These
// back the panel if the host page hasn't wired up brollCandidates / scene-
// specific suggestions. Coverr URLs previously used here all returned 404
// from cdn.coverr.co; switched to assets.mixkit.co which is stable.
const FALLBACK_BROLL: BrollCandidate[] = [
  {
    id: "cv_city_timelapse",
    label: "City Timelapse",
    preview_url: "https://assets.mixkit.co/videos/39876/39876-720.mp4",
  ...
  },
  {
    id: "cv_ocean_waves",
    label: "Ocean Waves",
    preview_url: "https://assets.mixkit.co/videos/4640/4640-720.mp4",
  ...
  },
  {
    id: "cv_coffee_pour",
    label: "Coffee Pour",
    preview_url: "https://assets.mixkit.co/videos/4560/4560-720.mp4",
  ...
  },
  {
    id: "cv_forest",
    label: "Forest Trail",
    preview_url: "https://assets.mixkit.co/videos/32754/32754-720.mp4",
  ...
  },
  {
    id: "cv_laptop_typing",
    label: "Laptop Typing",
    preview_url: "https://assets.mixkit.co/videos/4752/4752-720.mp4",
  ...
  },
  {
    id: "cv_skateboarder",
    label: "Skateboarder",
    preview_url: "https://assets.mixkit.co/videos/4253/4253-720.mp4",
    thumbnail_url: "https://images.unsplash.com/photo-1583336663277-620dc1996580?w=320&h=180&fit=crop",
    duration_sec: 10,
    provider: "mixkit",
    author: "Mixkit",
  },
  {
    id: "cv_neon_city",
    label: "Neon City",
    preview_url: "https://assets.mixkit.co/videos/4832/4832-720.mp4",
  ...
  },
  {
    id: "cv_mountain_road",
    label: "Mountain Road",
    preview_url: "https://assets.mixkit.co/videos/4624/4624-720.mp4",
  ...
  },
  {
    id: "cv_product_desk",
    label: "Product Desk",
    preview_url: "https://assets.mixkit.co/videos/4770/4770-720.mp4",
  ...
  },
  {
    id: "cv_gym_workout",
    label: "Gym Workout",
    preview_url: "https://assets.mixkit.co/videos/4773/4773-720.mp4",
  ...
  },
  {
    id: "cv_cafe_morning",
    label: "Cafe Morning",
    preview_url: "https://assets.mixkit.co/videos/4547/4547-720.mp4",
  ...
  },
  {
    id: "cv_rain_window",
    label: "Rain Window",
    preview_url: "https://assets.mixkit.co/videos/4765/4765-720.mp4",
