          ...
          >
            <div className="p-5 space-y-5">
              ...
              {agent.href && (
                <Link
                  href={agent.href}
                  className="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-[rgba(212,255,0,0.15)] border border-[rgba(212,255,0,0.3)] px-3 py-2 text-sm font-medium text-[#D4FF00] hover:bg-[rgba(212,255,0,0.25)] transition-colors"
                >
                  Open {agent.name}
