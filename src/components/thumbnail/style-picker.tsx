    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 rounded-lg border border-border bg-black/5 px-3 py-2 text-sm text-foreground placeholder:text-muted focus:border-border focus:outline-none"
        />
      ...
      <div className="flex flex-wrap gap-1.5">
        <button
          ...
          className={`rounded-full px-3 py-1 text-xs transition ${
            activeCategory === "all"
              ? "bg-white text-black"
              : "bg-black/5 text-muted hover:bg-black/5"
          }`}
        >
          All
        </button>
