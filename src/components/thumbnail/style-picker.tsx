    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 rounded-lg border border-border-subtle bg-black/5 px-3 py-2 text-sm text-text-primary placeholder:text-text-muted focus:border-border-subtle focus:outline-none"
        />
      ...
      <div className="flex flex-wrap gap-1.5">
        <button
          ...
          className={`rounded-full px-3 py-1 text-xs transition ${
            activeCategory === "all"
              ? "bg-white text-black"
              : "bg-black/5 text-text-muted hover:bg-black/5"
          }`}
        >
          All
        </button>
          ...
          return (
            ...
            >
              ...
              <div className="relative flex h-full flex-col justify-end bg-gradient-to-t from-black/70 via-black/20 to-transparent p-2">
                ...
                <div className="line-clamp-2 text-[10px] text-text-muted">
                  {style.description}
                </div>
              </div>
