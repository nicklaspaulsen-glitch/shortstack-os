            ...
            {looped.map((item, i) => {
                ...
                return (
                  ...
                  >
                    <div className="absolute inset-0 flex flex-col justify-center p-3 text-left">
                      {item.tag && (
                        <span className="text-[9px] uppercase tracking-widest text-[rgba(59,130,246,0.8)] font-semibold mb-1.5">
                          {item.tag}
                        </span>
                      )}
                      {item.title && (
              ...
              return (
                ...
                >
                  ...
                  />
                  {item.tag && (
                    <span className="absolute bottom-1.5 left-1.5 text-[9px] font-semibold px-1.5 py-0.5 rounded-full bg-black/70 text-[#2563EB] border border-[rgba(59,130,246,0.3)] opacity-0 group-hover:opacity-100 transition-opacity">
                      {item.tag}
                    </span>
                  )}
                </div>
