    ...
    <div className="h-12 flex items-center gap-2 px-3 border-b border-white/10 bg-[#1a1a2e] shrink-0 z-20">
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-1.5 px-3 h-7 rounded text-xs font-medium bg-[#3B82F6] hover:bg-[#d4b35e] text-[#1a1a2e] font-semibold transition-colors disabled:opacity-50"
        >
          {isExporting ? (
