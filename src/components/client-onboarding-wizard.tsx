              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {data.content_topics.map((t) => (
                    <span
                      key={t}
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[rgba(212,255,0,0.08)] border border-[rgba(212,255,0,0.2)] text-xs text-text-primary font-medium"
                    >
                      {t}
                      <button
                ...
                <div className="flex flex-wrap gap-1.5 mt-3">
                  {TOPIC_SUGGESTIONS.filter((t) => !data.content_topics.includes(t)).map((t) => (
                    <button
                      ...
                      className="text-[11px] text-text-muted border border-dashed border-border-subtle px-2.5 py-1 rounded-full hover:border-[rgba(212,255,0,0.4)] hover:text-text-primary transition-colors"
                    >
                      + {t}
                    </button>
                  ))}
                ...
                return (
                  <div
                    ...
                    className={`card flex items-center gap-4 transition-all ${
                      connected ? "border-[rgba(212,255,0,0.4)] bg-[rgba(212,255,0,0.02)]" : ""
                    }`}
                  >
                    <div
