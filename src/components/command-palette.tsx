...
export default function CommandPalette() {
  ...
  const commands: CommandItem[] = [
    ...
    { id: "socials", label: "Socials", icon: <Link2 size={14} />, action: () => nav("/dashboard/integrations-hub"), category: "Navigate", keywords: "connect oauth instagram facebook" },
    { id: "integrations", label: "Integrations", icon: <Link2 size={14} />, action: () => nav("/dashboard/integrations-hub"), category: "Navigate", keywords: "integrations zernio connect oauth platforms apps" },
