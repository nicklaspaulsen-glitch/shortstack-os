...
export default function GlobalSearch() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 bg-surface border border-border-subtle rounded-lg px-3 py-1.5 text-sm text-text-muted hover:border-[rgba(59,130,246,0.25)] transition-colors"
    >
      <Search size={14} />
      <span>Search...</span>
