    ...
    <div className="space-y-5">
          ...
          <div className="space-y-2">
            {links.map((link) => (
              <div key={link.id} className="p-3 rounded-xl border border-border-subtle bg-surface-light/30 flex items-center gap-3">
                ...
                <span className="text-sm font-bold text-[#D4FF00] shrink-0">
      ...
      <div className="glass rounded-xl p-4">
        ...
        <button
          ...
          className="text-[10px] text-[#D4FF00] hover:underline flex items-center gap-1 mb-3"
        >
                ...
                <span
                  className={`text-[9px] px-2 py-0.5 rounded-full font-bold uppercase ${
                    inv.status === "paid"
                      ...
                      : inv.status === "open"
                      ? "bg-[rgba(212,255,0,0.08)] text-[#D4FF00]"
