  ...
  return (
    <div className="relative flex items-center gap-3 px-4 py-3  border border-amber-500/25 bg-gradient-to-r from-amber-500/[0.06] via-orange-500/[0.04] to-transparent">
      ...
      <Link
        ...
        className="shrink-0 hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[#D4FF00] text-[#020711] text-xs font-semibold hover:bg-[#AACC00] transition-colors shadow-sm"
      >
      ...
      <Link
        href="/dashboard/upgrade"
        className="shrink-0 sm:hidden p-2 rounded-xl bg-[#D4FF00] text-[#020711] hover:bg-[#AACC00] transition-colors"
        aria-label="Upgrade"
      >
        <ArrowUpRight size={12} />
      </Link>
