...
export default function TokenUsageWidget() {
  ...
  const {
    ...
    return {
      ...
      clampedPct: cPct,
      ringColor: isUnlimited ? "#22c55e" : getRingColor(cPct),
  ...
  return (
    <Draggable
      dragAnywhere
      defaultX={typeof window !== "undefined" ? window.innerWidth - 258 : 0}
      defaultY={typeof window !== "undefined" ? window.innerHeight - 80 : 0}
      storageKey="token_widget_v3"
    >
    <div
      ...
      <Link
        ...
        className={`group flex items-center gap-2 pl-2 pr-3 py-1.5 rounded-full bg-surface border shadow-lg backdrop-blur transition-all hover:scale-[1.02] active:scale-95 ${
          atLimit
            ...
            : "border-border-subtle hover:border-[rgba(212,255,0,0.4)]"
        }`}
        style={{
          background:
