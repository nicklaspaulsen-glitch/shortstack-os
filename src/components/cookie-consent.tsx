    ...
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-6 md:max-w-sm z-50 animate-in slide-in-from-bottom-4 duration-300">
      <div className="bg-surface border border-border-subtle/40 rounded-lg p-4 shadow-xl backdrop-blur-sm">
        <p className="text-xs text-text-muted leading-relaxed mb-3">
          ...
          <a href="/cookies" className="text-[#D4FF00] hover:text-[#D4FF00] underline underline-offset-2">
            Cookie Policy
          </a>
        </p>
        <div className="flex gap-2">
          <button
            onClick={accept}
            className="flex-1 px-3 py-1.5 bg-[#D4FF00]/10 text-[#D4FF00] text-xs font-medium rounded border border-[#D4FF00]/20 hover:bg-[#D4FF00]/20 transition-colors"
          >
            Got it
          </button>
        </div>
