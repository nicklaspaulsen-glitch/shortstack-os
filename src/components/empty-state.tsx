...
export default function EmptyState({
  ...
  return (
    <div className="pop-fade relative flex flex-col items-center justify-center text-center py-16 px-6 border border-dashed border-border-subtle bg-gradient-to-b from-[rgba(212,255,0,0.02)] to-transparent overflow-hidden">
      {/* Background pattern */}
      <div
