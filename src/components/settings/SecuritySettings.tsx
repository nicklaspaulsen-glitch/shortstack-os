  ...
  return (
    <div className="space-y-4">
      <div className="glass rounded-xl p-4">
        ...
        <div className="flex items-center justify-between p-4 bg-surface-light/50 rounded-lg border border-border-subtle">
          <div>
            <p className="text-sm font-medium">2FA via Authenticator App</p>
            <p className="text-xs text-text-muted">{twoFA ? "Enabled and protecting your account" : "Not enabled - we recommend enabling 2FA"}</p>
          </div>
          <button
      ...
      <div className="glass rounded-xl p-4">
        <h3 className="">Active Sessions</h3>
          ...
          {sessions.length === 0 ? (
            ...
            <div key={i} className="flex items-center justify-between p-3 border border-border-subtle rounded-lg">
              <div>
                ...
                <p className="text-xs text-text-muted">IP: {s.ip} | Last active: {new Date(s.last_active).toLocaleString()}</p>
              </div>
