...
export const SIDEBAR_CATEGORIES: {
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/affiliates", label: "Commissions" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/webhooks", label: "PlugsConnected" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/integrations-hub", label: "Socials" },
      { href: "/dashboard/competitive-monitor", label: "Competitors" },
      { href: "/dashboard/telegram-bot", label: "Telegram Robot" },
