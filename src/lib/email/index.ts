  ...
  return sendEmail({
    ...
    html: `
      <div style="${baseStyle}">
        ...
        <p style="color:#a0a0a0;font-size:14px;line-height:1.6;">
          Hi ${clientName}, your invoice for <strong style="color:#2563EB;">$${amount.toFixed(2)}</strong> is ready.
        </p>
        ${invoiceUrl ? `
          <div style="text-align:center;margin:24px 0;">
  ...
  return `
    <div style="margin-top:32px;padding-top:16px;border-top:1px solid #222;text-align:center;">
      <p style="color:#555;font-size:11px;line-height:1.6;margin:0;">
        ...
        <a href="${link}" style="color:#2563EB;text-decoration:underline;">Unsubscribe</a>
        &nbsp;·&nbsp;
        <a href="https://app.shortstack.work/privacy" style="color:#2563EB;text-decoration:underline;">Privacy Policy</a>
      </p>
    </div>
  `;
}
