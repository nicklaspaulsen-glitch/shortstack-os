  ...
  theme: {
    extend: {
      colors: {
        ...
        "border-subtle": "rgba(13, 148, 136, 0.07)",
        "border-strong": "rgba(13, 148, 136, 0.16)",
        ...
        "brand-accent": "rgb(var(--brand-accent-rgb, 45 212 191) / <alpha-value>)",
        "brand-accent-soft": "rgb(var(--brand-accent-soft-rgb, 94 234 212) / <alpha-value>)",
        "brand-accent-dim": "rgb(var(--brand-accent-dim-rgb, 13 148 136) / <alpha-value>)",
        "brand-lime": "rgb(var(--brand-lime-rgb, 45 212 191) / <alpha-value>)",
        "brand-lime-soft": "rgb(var(--brand-lime-soft-rgb, 94 234 212) / <alpha-value>)",
        "brand-lime-dim": "rgb(var(--brand-lime-dim-rgb, 13 148 136) / <alpha-value>)",
        "brand-plum": "rgb(var(--brand-plum-rgb, 31 31 35) / <alpha-value>)",
        "brand-plum-hover": "rgb(var(--brand-plum-hover-rgb, 44 44 50) / <alpha-value>)",
        "brand-indigo": "rgb(var(--brand-indigo-rgb, 45 212 191) / <alpha-value>)",
        // Status
        ...
        "gold-dark": "rgb(var(--color-accent-rgb, 13 148 136) / <alpha-value>)",
        "gold-light": "rgb(var(--color-accent-rgb, 13 148 136) / <alpha-value>)",
