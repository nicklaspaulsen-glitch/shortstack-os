  ...
  theme: {
    extend: {
      colors: {
        ...
        "brand-accent": "rgb(var(--brand-accent-rgb, 99 102 241) / <alpha-value>)",
        "brand-accent-soft": "rgb(var(--brand-accent-soft-rgb, 167 139 250) / <alpha-value>)",
        "brand-accent-dim": "rgb(var(--brand-accent-dim-rgb, 79 70 229) / <alpha-value>)",
        "brand-lime": "rgb(var(--brand-lime-rgb, 99 102 241) / <alpha-value>)",
        "brand-lime-soft": "rgb(var(--brand-lime-soft-rgb, 167 139 250) / <alpha-value>)",
        "brand-lime-dim": "rgb(var(--brand-lime-dim-rgb, 79 70 229) / <alpha-value>)",
